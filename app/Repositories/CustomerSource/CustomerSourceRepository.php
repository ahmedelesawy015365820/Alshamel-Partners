...
namespace App\Repositories\CustomerSource;

use Illuminate\Support\Facades\DB;

class CustomerSourceRepository implements CustomerSourceInterface
{

    public function __construct(private \App\Models\GeneralCustomerSource $model)
    {
        $this->model = $model;
    }
