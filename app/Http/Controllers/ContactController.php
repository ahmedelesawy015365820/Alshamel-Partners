...
class ContactController extends Controller
{
    ...
    public function find($id)
    {
        ...
        return responseJson(200, 'success', new ContactResource($model));
    }
    ...
    public function all(AllRequest $request)
    {
        ...
        return responseJson(200, 'success', ContactResource::collection($models['data']), $models['paginate'] ? getPaginates($models['data']) : null);
    }
