...
use App\Http\Requests\GeneralAccountsRequest;
use App\Http\Resources\GeneralAccountsResources;
...
class AccountController extends Controller
{
    ...
    public function find($id)
    {
        ...
        return responseJson(200, 'success', new GeneralAccountsResources($model));
    }
    ...
    public function all(Request $request)
    {
        ...
        return responseJson(200, 'success', GeneralAccountsResources::collection($models['data']), $models['paginate'] ? getPaginates($models['data']) : null);
    }

    public function create(GeneralAccountsRequest $request)
    {
    ...
    public function update($id, GeneralAccountsRequest $request)
    {
