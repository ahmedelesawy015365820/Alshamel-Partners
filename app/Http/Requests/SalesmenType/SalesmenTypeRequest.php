...
class SalesmenTypeRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'name' => 'nullable|unique:general_salesmen_types,name,'. ($this->method() == 'PUT' ?  $this->id : ''),
            'name_e' => 'nullable|unique:general_salesmen_types,name_e,'. ($this->method() == 'PUT' ?  $this->id : ''),
