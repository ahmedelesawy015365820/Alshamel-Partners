...
return [
    ...
    'attributes' => [
        ...
        'domain' => 'الدومن',
        'tax_number' => 'الضريبة',
        'enter_time' => 'وقت الوصول',
        'leave_time' => 'وقت المغادرة',
        'insurance' => 'التأمين',
        'revision_and_canceling' => 'الإلغاء والاسترجاع',
        'privacy_and_use' => 'السياسة والاستخدام',
        ...
        'logo' => 'الشعار',
        'iban' => 'رقم الحساب',
        'bank_account_name' => 'اسم مالك الحساب',
        'license_image' => 'صورة الترخيص',
        'popular_questions' => 'الأسئلة الشائعة',
        'entity_type' => 'نوع الكيان',
        'type' => 'النوع',
        'tax_license' => 'الرقم الضريبي',
        'identity' => 'الهوية',
        'avatar' => 'الصورة',
        'full_name' => 'الاسم بالكامل',
        'main_photos' => 'الصور الرئيسية',
        "name" => "الأسم",
        'name_e' => "الاسم بالانجليزية",
    ],
];
