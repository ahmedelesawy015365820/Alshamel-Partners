...
use Modules\BoardsRent\Http\Requests\SectorRequest;
use Modules\BoardsRent\Transformers\SectorResource;
...
class SectorController extends Controller
{
    ...
    public function create(SectorRequest $request)
    {
        ...
        return responseJson(200, 'created', new SectorResource($model));

    }

    public function update($id, SectorRequest $request)
    {
        $model = $this->model->find($id);
        if (!$model) {
            return responseJson(404, 'not found');
        ...
        return responseJson(200, 'updated', new SectorResource($model));
    }
