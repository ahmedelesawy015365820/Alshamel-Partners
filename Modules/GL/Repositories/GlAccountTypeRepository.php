...
use Modules\GL\Entities\GlAccountType;


class GlAccountTypeRepository implements GlAccountTypeRepositoryInterface
{

    private $model;
    private $setting;

    public function __construct(GlAccountType $model, UserSettingScreen $setting)
    {
        $this->model = $model;
