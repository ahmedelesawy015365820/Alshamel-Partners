...
namespace Modules\RealEstate\Repositories\RlstCustomTable;

use Illuminate\Support\Facades\DB;
use Modules\RealEstate\Entities\RealestateCustomTable;

class RlstCustomTableRepository implements RlstCustomTableInterface
{

    public function __construct(private RealestateCustomTable $model)
    {
        $this->model = $model;
    }
