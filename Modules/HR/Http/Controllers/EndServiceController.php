...
use Modules\HR\Transformers\EndServiceResource;

class EndServiceController extends Controller
{

    public function __construct(private EndService $model, private Employee $modelEmployee)
    {
        $this->model = $model;
    ...
    public function all(Request $request)
    {
        ...
        return responseJson(200, 'success', EndServiceResource::collection($models['data']), $models['paginate'] ? getPaginates($models['data']) : null);
    }
    ...
    public function create(Request $request)
    {
        ...
        return responseJson(200, 'created', new EndServiceResource($employee));
    }
