...
use Modules\RecievablePayable\Entities\RpScreenSubContactGroup;
use Modules\RecievablePayable\Entities\RpSubContactGroup;

class RpScreenSubContactGroupRepository implements RpScreenSubContactGroupRepositoryInterface
{

    private $model;
    private $setting;

    public function __construct(RpScreenSubContactGroup $model, UserSettingScreen $setting)
    {
        $this->model = $model;
    ...
    public function create($request)
    {
        DB::transaction(function () use ($request) {
            ...
            cacheForget("RpScreenSubContactGroup");
        });
    }
    ...
    {
        $keys = [
            "RpScreenSubContactGroup",
            "RpScreenSubContactGroup_" . $id,
        ];
        foreach ($keys as $key) {
            cacheForget($key);
        }
