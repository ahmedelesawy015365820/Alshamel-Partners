...
class RpSubContactGroupRepository implements RpSubContactGroupRepositoryInterface
{

    private $model;
    private $setting;

    public function __construct(RpSubContactGroup $model, UserSettingScreen $setting)
    {
        $this->model = $model;
