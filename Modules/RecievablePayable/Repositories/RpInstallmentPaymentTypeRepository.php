...
class RpInstallmentPaymentTypeRepository implements RpInstallmentPaymentTypeRepositoryInterface
{

    private $model;
    private $setting;

    public function __construct(RpInstallmentPaymentType $model, UserSettingScreen $setting)
    {
        $this->model = $model;
    ...
    public function create($request)
    {
        DB::transaction(function () use ($request) {
            ...
            cacheForget("RpInstallmentPaymentType");
        });
    }
    ...
    {
        $keys = [
            "RpInstallmentPaymentType",
            "RpInstallmentPaymentType_" . $id,
        ];
        foreach ($keys as $key) {
            cacheForget($key);
        }
