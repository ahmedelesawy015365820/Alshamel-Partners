...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    getAllOwners: function getAllOwners() {
      var _this3 = this;
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var res, l;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.prev = 1;
              _context.next = 4;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].get("/real-estate/owners/get-drop-down");
            case 4:
              res = _context.sent;
              l = res.data.data;
              _this3.owners = l;
    ...
    getAllBuildings: function getAllBuildings() {
      var _this4 = this;
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        var filter, i, _i, _i2, res, buildings;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.prev = 1;
              filter = "";
              for (i = 0; i < _this4.country_id.length; ++i) {
                filter += "country_ids[".concat(i, "]=").concat(_this4.country_id[i], "&");
              }
              for (_i = 0; _i < _this4.governorate_id.length; ++_i) {
                filter += "governorate_ids[".concat(_i, "]=").concat(_this4.governorate_id[_i], "&");
              }
              for (_i2 = 0; _i2 < _this4.city_id.length; ++_i2) {
                filter += "city_ids[".concat(_i2, "]=").concat(_this4.city_id[_i2], "&");
              }
              _context2.next = 8;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].get("/real-estate/buildings/get-drop-down?".concat(filter));
            case 8:
              res = _context2.sent;
              buildings = res.data.data;
              _this4.buildings = buildings;
              if (_this4.isAll) {
                _this4.allBuildings = buildings;
              } else {
                _this4.countries = _this4.allCountries;
                _this4.cities = _this4.allCities;
                _this4.governorates = _this4.allGovernorates;
              }
              _context2.next = 17;
              break;
            case 14:
    ...
    getWalletOwnersBuliding: function getWalletOwnersBuliding(e) {
      var _this5 = this;
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _this5.building_id = [];
              _context3.next = 7;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].post("/real-estate/units/building-wallet", {
                wallet_ids: _this5.wallet_id
              });
            case 7:
              res = _context3.sent;
              l = res.data.data;
              ...
              l.forEach(function (el) {
                return own.push.apply(own, _toConsumableArray(el.owners));
              });
              l.forEach(function (el) {
                return bui.push.apply(bui, _toConsumableArray(el.buildings));
              });
              _this5.owners = own;
              _this5.buildings = bui;
              _context3.next = 19;
              break;
            case 16:
              _context3.prev = 16;
    ...
    getData: function getData() {
      ...
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].post("/real-estate/un-sold-unit-report", {
        page: page,
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _context4.next = 3;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].get("/real-estate/wallets/get-drop-down").then(function (res) {
                var l = res.data.data;
                _this9.wallets = l;
                if (_this9.isAll) {
                  _this9.allWallets = l;
        ...
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              ...
              _context6.next = 3;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].get("/salesmen/get-drop-down").then(function (res) {
                var l = res.data.data;
                _this11.sales = l;
              })["catch"](function (err) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_6___default().fire({
        ...
        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            case 0:
              ...
              _context7.prev = 1;
              _context7.next = 4;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].get("/countries/get-drop-down");
            case 4:
              res = _context7.sent;
              countries = res.data.data;
              _this12.countries = countries;
              if (_this12.isAll) {
                _this12.allCountries = countries;
              }
              _context7.next = 13;
              break;
            case 10:
        ...
        return _regeneratorRuntime().wrap(function _callee8$(_context8) {
          while (1) switch (_context8.prev = _context8.next) {
            case 0:
              ...
              filter = "";
              for (i = 0; i < _this13.country_id.length; ++i) {
                filter += "country_ids[".concat(i, "]=").concat(_this13.country_id[i], "&");
              }
              _context8.next = 5;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].get("/governorates/get-drop-down?".concat(filter)).then(function (res) {
                var l = res.data.data;
                _this13.governorates = l;
                if (_this13.isAll) {
                  _this13.allGovernorates = l;
                }
              })["catch"](function (err) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_6___default().fire({
                  icon: "error",
        ...
        return _regeneratorRuntime().wrap(function _callee9$(_context9) {
          while (1) switch (_context9.prev = _context9.next) {
            case 0:
              ...
              filter = "";
              for (i = 0; i < _this14.country_id.length; ++i) {
                filter += "country_ids[".concat(i, "]=").concat(_this14.country_id[i], "&");
              }
              for (_i3 = 0; _i3 < _this14.governorate_id.length; ++_i3) {
                filter += "governorate_ids[".concat(_i3, "]=").concat(_this14.governorate_id[_i3], "&");
              }
              _context9.next = 6;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].get("/cities/get-drop-down?".concat(filter)).then(function (res) {
                var l = res.data.data;
                if (_this14.isAll) {
                  _this14.allCities = l;
                }
        ...
        return _regeneratorRuntime().wrap(function _callee10$(_context10) {
          while (1) switch (_context10.prev = _context10.next) {
            case 0:
              ...
              _context10.prev = 1;
              _context10.next = 4;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].get("/real-estate/unit-type/get-drop-down");
            case 4:
              res = _context10.sent;
              units = res.data.data;
              _this15.unit_ty = units;
              _context10.next = 12;
              break;
            case 9:
              _context10.prev = 9;
    ...
    showModelBuilding: function showModelBuilding(building) {
      var _this17 = this;
      if (this.building_id.length > 0 && this.building_id) {
        this.isBuilding = true;
        this.building_id.forEach(function (el) {
          var build = _this17.buildings.find(function (e) {
            return e.id == el;
          });
          if (build) {
            if (!_this17.country_id.includes(build.country_id) && build.country_id) {
              _this17.country_id.push(build.country_id);
            }
            if (!_this17.city_id.includes(build.city_id) && build.city_id) {
              _this17.city_id.push(build.city_id);
            }
            if (!_this17.governorate_id.includes(build.governorate_id) && build.governorate_id) {
              _this17.governorate_id.push(build.governorate_id);
            }
          }
        });
      } else {
    ...
    showCountryModel: function showCountryModel(countries) {
      if (countries.length > 0) {
        this.getGovernorates();
        this.getAllBuildings();
      }
    },
    showGovernorateModel: function showGovernorateModel(governorates) {
      var _this18 = this;
      if (governorates.length > 0) {
        this.city_id = [];
        governorates.forEach(function (el) {
          var governorate = _this18.governorates.find(function (e) {
            return e.id == el;
          });
          if (!_this18.country_id.includes(governorate.country_id) && governorate.country_id) {
            _this18.country_id.push(governorate.country_id);
          }
        });
        this.getCities();
        this.getAllBuildings();
    ...
    showCityModel: function showCityModel(cities) {
      var _this19 = this;
      if (cities.length > 0) {
        cities.forEach(function (el) {
          var city = _this19.cities.find(function (e) {
            return e.id == el;
          });
          if (!_this19.country_id.includes(city.country_id) && city.country_id) {
            _this19.country_id.push(city.country_id);
          }
          if (!_this19.governorate_id.includes(city.governorate_id) && city.governorate_id) {
            _this19.governorate_id.push(city.governorate_id);
          }
        });
        this.getAllBuildings();
      }
...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("b-modal", {
    ...
    attrs: {
      ...
      "custom-label": function customLabel(opt) {
        return _vm.wallets.find(function (x) {
          return x.id == opt;
        }) ? _vm.$i18n.locale == "ar" ? _vm.wallets.find(function (x) {
          return x.id == opt;
    ...
    on: {
      input: _vm.getWalletOwnersBuliding
    },
    model: {
      value: _vm.wallet_id,
      callback: function callback($$v) {
    ...
    attrs: {
      ...
      "custom-label": function customLabel(opt) {
        var owner = _vm.owners.find(function (x) {
          return x.id == opt;
        });
        if (owner) {
          return _vm.$i18n.locale == "ar" ? owner.name : owner.name_e;
        } else {
    ...
    attrs: {
      ...
      "custom-label": function customLabel(opt) {
        var building = _vm.buildings.find(function (x) {
          return x.id == opt;
        });
        if (building) {
          return _vm.$i18n.locale == "ar" ? building.name : building.name_e;
        } else {
    ...
    on: {
      input: _vm.showGovernorateModel
    },
    model: {
    ...
    attrs: {
      ...
      "custom-label": function customLabel(opt) {
        return _vm.properties.find(function (x) {
          return x.id == opt;
        }) ? _vm.$i18n.locale == "ar" ? _vm.properties.find(function (x) {
          return x.id == opt;
    ...
    staticClass: "col-md-2"
  }, [_c("label", [_vm._v(_vm._s(_vm.$t("general.Unit_type")))]), _vm._v(" "), _c("multiselect", {
    attrs: {
      options: _vm.unit_ty.map(function (type) {
        return type.id;
      }),
      "custom-label": function customLabel(opt) {
        return _vm.$i18n.locale == "ar" ? _vm.unit_ty.find(function (x) {
          return x.id == opt;
        }).name : _vm.unit_ty.find(function (x) {
          return x.id == opt;
        }).name_e;
      }
    },
    model: {
      value: _vm.unit_ty_id,
      callback: function callback($$v) {
        _vm.unit_ty_id = $$v;
      },
      expression: "unit_ty_id"
    }
  })], 1), _vm._v(" "), _c("div", {
    staticClass: "col-md-2"
  ...
  }, [_vm._v(_vm._s(_vm.$t("general.clearFilter")))])], 1)]), _vm._v(" "), _c("div", {
    staticClass: "row"
  }, [_c("div", {
    staticClass: "col-12"
  }, [_c("div", {
  ...
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("realEstate_unit_name_ar")))])])]), _vm._v(" "), _vm.setting.building ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  ...
  })])])]) : _vm._e(), _vm._v(" "), _vm.setting.country ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("country")))])])]) : _vm._e(), _vm._v(" "), _vm.setting.governorate ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("governorate")))])])]) : _vm._e(), _vm._v(" "), _vm.setting.city ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
  }, [_c("span", [_vm._v(_vm._s(_vm.getCompanyKey("city")))])])]) : _vm._e(), _vm._v(" "), _vm.setting.unit_ty ? _c("th", [_c("div", {
    staticClass: "d-flex justify-content-center"
