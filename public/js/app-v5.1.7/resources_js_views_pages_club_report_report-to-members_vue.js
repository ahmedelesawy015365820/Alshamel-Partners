...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("div", {
    ...
    on: {
      click: function click($event) {
        _vm.installmentStatus.sort(_vm.sortString("home_address"));
      }
    }
  }), _vm._v(" "), _c("i", {
    staticClass: "fas fa-arrow-down",
    ...
    on: {
      click: function click($event) {
        _vm.installmentStatus.sort(_vm.sortString("work_address"));
      }
    }
  }), _vm._v(" "), _c("i", {
    staticClass: "fas fa-arrow-down",
    ...
    on: {
      click: function click($event) {
        _vm.installmentStatus.sort(_vm.sortString("job"));
      }
    }
  }), _vm._v(" "), _c("i", {
    staticClass: "fas fa-arrow-down",
    ...
    on: {
      click: function click($event) {
        _vm.installmentStatus.sort(_vm.sortString("degree"));
      }
    }
  }), _vm._v(" "), _c("i", {
    staticClass: "fas fa-arrow-down",
