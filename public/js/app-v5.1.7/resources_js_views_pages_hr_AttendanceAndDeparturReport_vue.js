(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_views_pages_hr_AttendanceAndDeparturReport_vue"],{
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/hr/AttendanceAndDeparturReport.vue?vue&type=script&lang=js&":
/*!**************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/hr/AttendanceAndDeparturReport.vue?vue&type=script&lang=js& ***!
  \**************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  page: {
    ...
    meta: [{
      name: "description",
      content: "Attendance And Departure"
    }]
  },
  ...
  beforeRouteEnter: function beforeRouteEnter(to, from, next) {
    next(function (vm) {
      return (0,_helper_permission__WEBPACK_IMPORTED_MODULE_3__["default"])(vm, "Attendance And Departure Report", "all attendanceAndDeparture hr");
    });
  },
  components: {
  ...
  data: function data() {
    return {
      ...
      tableSetting: [{
        isFilter: false,
        isSet: true,
        trans: "attendance_and_departure_employee_id",
        isV: 'employee_id',
        type: 'string',
        sort: true,
        setting: {
        ...
        isFilter: false,
        isSet: true,
        trans: "attendance_and_departure_employee_name",
        isV: 'name',
        type: 'string',
        sort: true,
        setting: {
        ...
        isFilter: false,
        isSet: true,
        trans: "attendance_and_departure_day",
        isV: 'day',
        type: 'string',
        sort: true,
        setting: {
        ...
        isFilter: false,
        isSet: true,
        trans: "attendance_and_departure_attendance",
        isV: 'attend_1',
        type: 'string',
        sort: true,
        setting: {
        ...
        isFilter: false,
        isSet: true,
        trans: "attendance_and_departure_departure",
        isV: 'depart_1',
        type: 'string',
        sort: true,
        setting: {
        ...
        isFilter: false,
        isSet: true,
        trans: "attendance_and_departure_attendance_shift2",
        isV: 'attend_2',
        type: 'string',
        sort: true,
        setting: {
        ...
        isFilter: false,
        isSet: true,
        trans: "attendance_and_departure_departure_shift2",
        isV: 'depart_2',
        type: 'string',
        sort: true,
        setting: {
        ...
        isFilter: false,
        isSet: true,
        trans: "attendance_and_departure_delay",
        isV: 'late',
        type: 'string',
        sort: true,
        setting: {
        ...
        isFilter: false,
        isSet: true,
        trans: "attendance_and_departure_additional",
        isV: 'overtime',
        type: 'string',
        sort: true,
        setting: {
        ...
        isFilter: false,
        isSet: true,
        trans: "attendance_and_departure_Actualnumberofhours",
        isV: 'exact_hours',
        type: 'string',
        sort: true,
        setting: {
        ...
        isFilter: false,
        isSet: true,
        trans: "attendance_and_departure_absence",
        isV: 'absence',
        type: 'string',
        sort: true,
        setting: {
        ...
        isFilter: false,
        isSet: true,
        trans: "attendance_and_departure_note",
        isV: 'notes',
        type: 'string',
        sort: true,
        setting: {
  ...
  methods: {
    ...
    getDataAttend: function getDataAttend() {
      var _this = this;
      ...
      if (this.$v.create.$invalid) {
        ...
        this.isLoader = true;
        var filter = '';
        for (var i = 0; i < this.create.employeesIds.length; ++i) {
          filter += "&employeesIds[".concat(i, "]=").concat(this.create.employeesIds[i]);
        }
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_11__["default"].get("".concat(this.url, "?month=").concat(this.create.month, "&year=").concat(this.create.year, "&department_id=").concat(this.create.department_id, "&branch_id=").concat(this.create.branch_id, "&page=").concat(page, "&per_page=50").concat(filter)).then(function (res) {
          var l = res.data;
          _this.tables = l.data;
          _this.objPagination = l.pagination;
          _this.current_page = parseInt(l.pagination.current_page);
        })["catch"](function (err) {
    ...
    getDataCurrentPageAttend: function getDataCurrentPageAttend() {
      var _this2 = this;
      var page = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;
      this.$v.create.$touch();
      if (this.$v.create.$invalid) {
        ...
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_11__["default"].get("".concat(this.url, "?month=").concat(this.create.month, "&year=").concat(this.create.year, "&department_id=").concat(this.create.department_id, "&branch_id=").concat(this.create.branch_id, "&page=").concat(page, "&per_page=50").concat(filter)).then(function (res) {
          var l = res.data;
          _this2.tables = l.data;
          _this2.objPagination = l.pagination;
          _this2.current_page = parseInt(l.pagination.current_page);
        })["catch"](function (err) {
          sweetalert2__WEBPACK_IMPORTED_MODULE_12___default().fire({
            icon: 'error',
    ...
    getDepartnent: function getDepartnent() {
      var _this3 = this;
      this.isLoader = true;
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_11__["default"].get("/depertments/get-drop-down").then(function (res) {
        var l = res.data.data;
        _this3.departments = l;
        _this3.create.employeesIds = [];
      })["catch"](function (err) {
    ...
    getBranches: function getBranches() {
      var _this4 = this;
      this.isLoader = true;
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_11__["default"].get("/branches/get-drop-down").then(function (res) {
        var l = res.data.data;
        _this4.branches = l;
        _this4.create.employeesIds = [];
      })["catch"](function (err) {
    ...
    getEmployees: function getEmployees() {
      var _this5 = this;
      this.isLoader = true;
      var department = this.create.department_id ? "&department_id=".concat(this.create.department_id) : '';
      var branch = this.create.branch_id ? "&branch_id=".concat(this.create.branch_id) : '';
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_11__["default"].get("/employees/get-drop-down?limet=30".concat(department).concat(branch)).then(function (res) {
        var l = res.data.data;
        _this5.employees = l;
      })["catch"](function (err) {
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/hr/AttendanceAndDeparturReport.vue?vue&type=template&id=ddc10a10&scoped=true&":
/*!*************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/hr/AttendanceAndDeparturReport.vue?vue&type=template&id=ddc10a10&scoped=true& ***!
  \*************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("div", {
    ...
    on: {
      hidden: function hidden($event) {
        return _vm.$bvModal.hide("filter");
      }
    }
  }, [_c("form", [_c("div", {
    ...
    model: {
      ...
      callback: function callback($$v) {
        _vm.$set(_vm.$v.create.month, "$model", $$v);
      },
      expression: "$v.create.month.$model"
    }
  }), _vm._v(" "), _vm.$v.create.month.$error ? _c("div", {
  ...
  }), _vm._v(" "), _vm.$v.create.year.$error ? _c("div", {
    staticClass: "text-danger"
  }, [_vm._v("\n                                            " + _vm._s(_vm.$t("general.fieldIsRequired")) + "\n                                        ")]) : _vm._e()], 1)]), _vm._v(" "), _c("div", {
    staticClass: "col-md-6"
  }, [_c("div", {
    ...
    staticClass: "control-label"
  }, [_vm._v("\n                                            " + _vm._s(_vm.getCompanyKey("attendance_and_departure_employees")) + "\n                                        ")]), _vm._v(" "), _c("multiselect", {
    attrs: {
      multiple: true,
    ...
    model: {
      value: _vm.$v.create.employeesIds.$model,
      callback: function callback($$v) {
        _vm.$set(_vm.$v.create.employeesIds, "$model", $$v);
      },
      expression: "$v.create.employeesIds.$model"
    }
  }), _vm._v(" "), _vm.$v.create.employeesIds.$error ? _c("div", {
    staticClass: "text-danger"
  }, [_vm._v("\n                                            " + _vm._s(_vm.$t("general.fieldIsRequired")) + "\n                                        ")]) : _vm._e()], 1)])])])]), _vm._v(" "), _c("div", {
...
/***/ "./resources/js/views/pages/hr/AttendanceAndDeparturReport.vue":
/*!*********************************************************************!*\
  !*** ./resources/js/views/pages/hr/AttendanceAndDeparturReport.vue ***!
  \*********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _AttendanceAndDeparturReport_vue_vue_type_template_id_ddc10a10_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./AttendanceAndDeparturReport.vue?vue&type=template&id=ddc10a10&scoped=true& */ "./resources/js/views/pages/hr/AttendanceAndDeparturReport.vue?vue&type=template&id=ddc10a10&scoped=true&");
/* harmony import */ var _AttendanceAndDeparturReport_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./AttendanceAndDeparturReport.vue?vue&type=script&lang=js& */ "./resources/js/views/pages/hr/AttendanceAndDeparturReport.vue?vue&type=script&lang=js&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! !../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
;
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _AttendanceAndDeparturReport_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _AttendanceAndDeparturReport_vue_vue_type_template_id_ddc10a10_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render,
  _AttendanceAndDeparturReport_vue_vue_type_template_id_ddc10a10_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "ddc10a10",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/views/pages/hr/AttendanceAndDeparturReport.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);
...
/***/ "./resources/js/views/pages/hr/AttendanceAndDeparturReport.vue?vue&type=script&lang=js&":
/*!**********************************************************************************************!*\
  !*** ./resources/js/views/pages/hr/AttendanceAndDeparturReport.vue?vue&type=script&lang=js& ***!
  \**********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_AttendanceAndDeparturReport_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./AttendanceAndDeparturReport.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/hr/AttendanceAndDeparturReport.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_AttendanceAndDeparturReport_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 
...
/***/ "./resources/js/views/pages/hr/AttendanceAndDeparturReport.vue?vue&type=template&id=ddc10a10&scoped=true&":
/*!****************************************************************************************************************!*\
  !*** ./resources/js/views/pages/hr/AttendanceAndDeparturReport.vue?vue&type=template&id=ddc10a10&scoped=true& ***!
  \****************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_AttendanceAndDeparturReport_vue_vue_type_template_id_ddc10a10_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_AttendanceAndDeparturReport_vue_vue_type_template_id_ddc10a10_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_AttendanceAndDeparturReport_vue_vue_type_template_id_ddc10a10_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./AttendanceAndDeparturReport.vue?vue&type=template&id=ddc10a10&scoped=true& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/hr/AttendanceAndDeparturReport.vue?vue&type=template&id=ddc10a10&scoped=true&");
