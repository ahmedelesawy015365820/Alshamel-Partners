(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_views_pages_recievablePayable_documentTransaction_paymentVoucher_vue"],{
  ...
  methods: {
    ...
    AddSubmit: function AddSubmit() {
      ...
      if (this.$v.create.$invalid && !this.financial_years_validate) {
        ...
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_0__["default"].post("voucher-headers", _objectSpread(_objectSpread({}, data_create), {}, {
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 3;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_0__["default"].get("/client-types/get-drop-down").then(function (res) {
                var l = res.data.data;
                _this11.clientTypes = l;
              })["catch"](function (err) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire({
                  icon: "error",
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _context4.next = 3;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_0__["default"].get("/branches?document_id=".concat(_this12.document_id)).then(function (res) {
                _this12.isLoader = false;
                var l = res.data.data;
                _this12.branches = l;
                if (_this12.branches.length == 1) {
                  _this12.create.branch_id = _this12.branches[0].id;
                  _this12.getSerialNumber('create', _this12.create.branch_id);
                }
              })["catch"](function (err) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire({
                  icon: "error",
        ...
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              ...
              _context6.next = 4;
              return _this14.getCustomers(employee_id);
            case 4:
            case "end":
        ...
        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            case 0:
              ...
              _context7.next = 5;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_0__["default"].get("/general-customer?limet=10&company_id=".concat(_this15.company_id, "&employee_id=").concat(employee_id, "&search=").concat(search, "&columns[0]=name&columns[1]=name_e&columns[2]=id")).then(function (res) {
                _this15.isLoader = false;
                var l = res.data.data;
                _this15.customers = l;
                if (_this15.customer_data_edit) {
                  if (!_this15.customers.find(function (e) {
                    return e.id == _this15.customer_data_edit.id;
                  })) {
                    _this15.customers.push(_this15.customer_data_edit);
                  }
                }
                if (_this15.customer_data_create) {
                  if (!_this15.customers.find(function (e) {
                    return e.id == _this15.customer_data_create.id;
                  })) {
                    _this15.customers.push(_this15.customer_data_create);
                  }
                }
              })["catch"](function (err) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire({
        ...
        return _regeneratorRuntime().wrap(function _callee9$(_context9) {
          while (1) switch (_context9.prev = _context9.next) {
            case 0:
              ...
              _this17.customerDebits = [];
              _this17.customerCredit = [];
              _this17.customer_data_create = _this17.customers.find(function (e) {
                return e.id == _this17.create.customer_id;
              });
              _this17.customer_data_edit = _this17.customers.find(function (e) {
                return e.id == _this17.create.customer_id;
              });
              _context9.next = 7;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_0__["default"].get("/recievable-payable/document-with-money-details?customer_id=".concat(id, "&with_paid=").concat(_this17.with_paid)).then(function (res) {
                _this17.isLoader = false;
                var l = res.data.data;
                l.forEach(function (e) {
                  if (parseFloat(e.debit) > 0) {
                    var _e$prev_settlement;
                    _this17.customerDebits.push({
                      id: e.id,
                      ...
                      serial_number: _this17.handelSerial(e),
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10() {
        ...
        return _regeneratorRuntime().wrap(function _callee10$(_context10) {
          while (1) switch (_context10.prev = _context10.next) {
            case 0:
              _this18.customerBreak = [];
              _this18.breakTransactions = [];
              _this18.totalOrderAmount = 0;
              _this18.totalTransferAmount = 0;
              _this18.openTransfer = false;
              _this18.amountPaid = 0;
              _this18.remainingAmount = 0;
              _this18.amount = 0;
              invoice = _this18.invoices.find(function (e) {
                return id == e.id;
              });
              _this18.serial_number = invoice.prefix;
              _this18.invoice_id = invoice.id;
              _context10.next = 13;
              return _this18.getCustomers(invoice.salesmen_id);
            case 13:
              _context10.next = 15;
              return _this18.getSalesmen();
            case 15:
              _context10.next = 17;
              return _this18.getPaymentMethod();
            case 17:
              _context10.next = 19;
              return _this18.getBranches();
            case 19:
              _this18.edit.date = invoice.date;
              _this18.edit.customer_id = invoice.customer_id;
              _this18.edit.salesmen_id = invoice.salesmen_id;
              _this18.edit.payment_method_id = invoice.payment_method_id;
              _this18.edit.branch_id = invoice.branch_id;
              _this18.edit.document_id = invoice.document_id;
              _this18.edit.amount = invoice.amount;
              _this18.customer_data_edit = invoice.customer;
              if (!(_this18.document && _this18.document.attributes && _this18.parseInt(document.attributes.customer) == -1)) {
                _context10.next = 33;
                break;
              }
              _context10.next = 30;
              return _this18.getBreakCustomer(_this18.edit.customer_id);
            case 30:
              _context10.next = 32;
              return _this18.getTransactions(id);
            case 32:
              _this18.amount = _this18.totalTransferAmount;
            case 33:
              _this18.errors = {};
            case 34:
            case "end":
        ...
        return _regeneratorRuntime().wrap(function _callee11$(_context11) {
          while (1) switch (_context11.prev = _context11.next) {
            case 0:
              ...
              branch = _this21.branches.find(function (row) {
                return e == row.id;
              });
        ...
        return _regeneratorRuntime().wrap(function _callee12$(_context12) {
          while (1) switch (_context12.prev = _context12.next) {
            case 0:
              ...
              date = type == 'create' ? _this22.create.date : _this22.edit.date;
              branch_id = type == 'create' ? _this22.create.branch_id : _this22.edit.branch_id;
              _context12.next = 5;
              return _this22.checkFinancialYears(date, branch_id);
            case 5:
            case "end":
          ...
          while (1) switch (_context13.prev = _context13.next) {
            case 0:
              ...
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_0__["default"].get("/document-headers/check-date?date=".concat(date)).then(function (res) {
                var l = res.data;
                if (!l) {
                  _this23.financial_years_validate = false;
                  sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire({
                    icon: "error",
                    title: "".concat(_this23.$t("general.Error")),
                    text: "".concat(_this23.$t("general.The date is outside the permitted fiscal year"))
                  });
                  _this23.serial_number = '';
                } else {
                  _this23.financial_years_validate = true;
                  var shortYear = new Date(date).getFullYear();
                  var twoDigitYear = shortYear.toString().substr(-2);
                  var branch = _this23.branches.find(function (row) {
                    return branch_id == row.id;
                  });
                  var serial = branch.serials.find(function (row) {
                    return _this23.document_id == row.document_id;
                  });
                  _this23.serial_number = "".concat(twoDigitYear, "-").concat(branch.id, "-").concat(_this23.document_id, "-").concat(serial.perfix);
                }
              })["catch"](function (err) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire({
                  icon: "error",
          ...
          while (1) switch (_context14.prev = _context14.next) {
            case 0:
              ...
              _this24.debounce = setTimeout(function () {
                _this24.getCustomers(_this24.create.salesmen_id, search);
              }, 500);
            case 3:
            case "end":
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee15() {
        ...
        return _regeneratorRuntime().wrap(function _callee15$(_context15) {
          while (1) switch (_context15.prev = _context15.next) {
            case 0:
              search = e !== null && e !== void 0 ? e : '';
              clearTimeout(_this25.debounce);
              _this25.debounce = setTimeout(function () {
                _this25.getCustomers(_this25.edit.salesmen_id, search);
              }, 500);
            case 3:
            case "end":
    ...
    ReturnTransactionToOrder: function ReturnTransactionToOrder(index) {
      ...
      orderReturn = this.customerBreak.find(function (e) {
        return e.id == _this26.breakTransactions[index].id;
      });
      if (orderReturn) {
    ...
    accountTotalAmount: function accountTotalAmount() {
      ...
      this.totalDebitSettlement = 0;
      this.customerDebits.forEach(function (el, index) {
        _this27.totalDebitSettlement += parseFloat(el.settlement_amount);
      });

      //account total amount transfer order
      this.totalCreditSettlement = 0;
      this.customerCredit.forEach(function (el, index) {
        _this27.totalCreditSettlement += parseFloat(el.settlement_amount);
      });
    },
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/recievablePayable/documentTransaction/paymentVoucher.vue?vue&type=script&lang=js&":
/*!************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/recievablePayable/documentTransaction/paymentVoucher.vue?vue&type=script&lang=js& ***!
  \************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  beforeRouteEnter: function beforeRouteEnter(to, from, next) {
    next(function (vm) {
      return (0,_helper_permission__WEBPACK_IMPORTED_MODULE_3__["default"])(vm, "Payment Voucher RP", "all paymentVoucher RP");
    });
  }
});
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/recievablePayable/documentTransaction/paymentVoucher.vue?vue&type=template&id=e6cca9a2&":
/*!***********************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/recievablePayable/documentTransaction/paymentVoucher.vue?vue&type=template&id=e6cca9a2& ***!
  \***********************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/js/views/pages/recievablePayable/documentTransaction/paymentVoucher.vue":
/*!*******************************************************************************************!*\
  !*** ./resources/js/views/pages/recievablePayable/documentTransaction/paymentVoucher.vue ***!
  \*******************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _paymentVoucher_vue_vue_type_template_id_e6cca9a2___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./paymentVoucher.vue?vue&type=template&id=e6cca9a2& */ "./resources/js/views/pages/recievablePayable/documentTransaction/paymentVoucher.vue?vue&type=template&id=e6cca9a2&");
/* harmony import */ var _paymentVoucher_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./paymentVoucher.vue?vue&type=script&lang=js& */ "./resources/js/views/pages/recievablePayable/documentTransaction/paymentVoucher.vue?vue&type=script&lang=js&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! !../../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
;
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _paymentVoucher_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _paymentVoucher_vue_vue_type_template_id_e6cca9a2___WEBPACK_IMPORTED_MODULE_0__.render,
  _paymentVoucher_vue_vue_type_template_id_e6cca9a2___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/views/pages/recievablePayable/documentTransaction/paymentVoucher.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);
...
/***/ "./resources/js/views/pages/recievablePayable/documentTransaction/paymentVoucher.vue?vue&type=script&lang=js&":
/*!********************************************************************************************************************!*\
  !*** ./resources/js/views/pages/recievablePayable/documentTransaction/paymentVoucher.vue?vue&type=script&lang=js& ***!
  \********************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_paymentVoucher_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./paymentVoucher.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/recievablePayable/documentTransaction/paymentVoucher.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_paymentVoucher_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 
...
/***/ "./resources/js/views/pages/recievablePayable/documentTransaction/paymentVoucher.vue?vue&type=template&id=e6cca9a2&":
/*!**************************************************************************************************************************!*\
  !*** ./resources/js/views/pages/recievablePayable/documentTransaction/paymentVoucher.vue?vue&type=template&id=e6cca9a2& ***!
  \**************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_paymentVoucher_vue_vue_type_template_id_e6cca9a2___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_paymentVoucher_vue_vue_type_template_id_e6cca9a2___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_lib_index_js_vue_loader_options_paymentVoucher_vue_vue_type_template_id_e6cca9a2___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./paymentVoucher.vue?vue&type=template&id=e6cca9a2& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/pages/recievablePayable/documentTransaction/paymentVoucher.vue?vue&type=template&id=e6cca9a2&");
