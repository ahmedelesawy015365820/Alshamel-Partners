...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  beforeRouteEnter: function beforeRouteEnter(to, from, next) {
    next(function (vm) {
      return (0,_helper_permission__WEBPACK_IMPORTED_MODULE_12__["default"])(vm, "Request Type", "all requestTypes hr");
    });
  },
  methods: {
    ...
    log: function log(id) {
      ...
      if (this.mouseEnter != id) {
        this.Tooltip = "";
        this.mouseEnter = id;
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/hr/request-types/logs/".concat(id)).then(function (res) {
          var l = res.data.data;
    ...
    getData: function getData() {
      ...
      _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/hr/request-types?page=".concat(page, "&per_page=").concat(this.per_page, "&search=").concat(this.search, "&").concat(filter)).then(function (res) {
        var l = res.data;
        _this4.requestTypes = l.data;
        _this4.requestTypesPagination = l.pagination;
    ...
    getDataCurrentPage: function getDataCurrentPage() {
      ...
      if (this.current_page <= this.requestTypesPagination.last_page && this.current_page != this.requestTypesPagination.current_page && this.current_page) {
        ...
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/hr/request-types?page=".concat(this.current_page, "&per_page=").concat(this.per_page, "&search=").concat(this.search, "&").concat(filter, "&company_id=").concat(this.company_id)).then(function (res) {
          var l = res.data;
      ...
      if (Array.isArray(id)) {
        sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
          ...
          if (result.value) {
            ...
            _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/hr/request-types/bulk-delete", {
              ids: id
            }).then(function (res) {
              _this6.checkAll = [];
              _this6.getData();
        ...
        sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
          ...
          if (result.value) {
            _this6.isLoader = true;
            _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"]["delete"]("/hr/request-types/".concat(id)).then(function (res) {
              _this6.checkAll = [];
              _this6.getData();
              sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
                icon: "success",
    ...
    AddSubmit: function AddSubmit() {
      ...
      if (this.$v.create.$invalid) {
        ...
        this.isLoader = true;
        this.errors = {};
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/hr/request-types", _objectSpread(_objectSpread({}, this.create), {}, {
    ...
    editSubmit: function editSubmit(id) {
      ...
      if (this.$v.edit.$invalid) {
        ...
        this.isLoader = true;
        this.errors = {};
        _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].put("/hr/request-types/".concat(id), this.edit).then(function (res) {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              requestTypes = _this12.requestTypes.find(function (e) {
                return id == e.id;
              });
              _this12.edit.name = requestTypes.name;
              _this12.edit.name_e = requestTypes.name_e;
              _this12.edit.start_from = requestTypes.start_from;
              _this12.edit.end_date = requestTypes.end_date;
              _this12.edit.amount = requestTypes.amount;
              _this12.edit.from_hour = requestTypes.from_hour;
              _this12.edit.to_hour = requestTypes.to_hour;
              _context2.next = 10;
              return _this12.getEmployees();
            case 10:
              requestTypes.managers.forEach(function (e) {
                _this12.edit.managers.push(e.id);
              });
              _this12.errors = {};
            case 12:
            case "end":
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/employees?manage_others=1").then(function (res) {
                _this14.employees = res.data.data;
              })["catch"](function (err) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
                  icon: "error",
...
var render = function render() {
  ...
  return _c("Layout", [_c("PageHeader"), _vm._v(" "), _c("div", {
    ...
    staticClass: "mr-2"
  }, [_vm._v("\n                                  " + _vm._s(_vm.getCompanyKey("request_type_managers")) + "\n                                  "), _c("span", {
    staticClass: "text-danger"
    ...
    model: {
      value: _vm.create.managers,
      callback: function callback($$v) {
        _vm.$set(_vm.create, "managers", $$v);
      },
      expression: "create.managers"
    }
  }), _vm._v(" "), _vm.errors.managers ? _vm._l(_vm.errors.managers, function (errorMessage, index) {
    return _c("ErrorMessage", {
      key: index
    }, [_vm._v(_vm._s(errorMessage))]);
    ...
    return _c("tr", {
      ...
      model: {
        value: _vm.edit.managers,
        callback: function callback($$v) {
          _vm.$set(_vm.edit, "managers", $$v);
        },
        expression: "edit.managers"
      }
    }), _vm._v(" "), _vm.errors.managers ? _vm._l(_vm.errors.managers, function (errorMessage, index) {
      return _c("ErrorMessage", {
        key: index
