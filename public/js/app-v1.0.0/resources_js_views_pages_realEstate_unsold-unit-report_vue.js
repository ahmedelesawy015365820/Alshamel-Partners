...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mounted: function mounted() {
    ...
    this.company_id = this.$store.getters["a uth/company_id"];
    this.getWallets();
  ...
  methods: {
    onOwnerSelected: function onOwnerSelected(wallet_id) {
      ...
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _this3.owner_id = null;
              _this3.building_id = null;
              _context.prev = 2;
              _context.next = 5;
              return _this3.getOwners(wallet_id);
            case 5:
              if (_this3.owners.length === 1) {
                // If the wallet has only one owner, automatically select that owner
                _this3.owner_id = _this3.owners[0].id;
                _this3.country_id = _this3.owners[0].country_id;
                console.log("country", _this3.country_id);
                _this3.governate_id = _this3.owners[0].governate_id;
                console.log("governate_id", _this3.governate_id);
                _this3.city_id = _this3.owners[0].city_id;
                console.log("city_id", _this3.city_id);
              }
              _context.next = 8;
              return _this3.getBuildings(wallet_id);
            case 8:
              if (_this3.buildings.length === 1) {
                // If the wallet has only one building, automatically select that building
                _this3.building_id = _this3.buildings[0].id;

                // Automatically select the country, governate, and city for the selected building
                selectedBuilding = _this3.buildings[0];
                _this3.country_id = selectedBuilding.country_id;
                _this3.governate_id = selectedBuilding.governate_id;
                _this3.city_id = selectedBuilding.city_id;
              }
              // here problem
              _context.next = 11;
              return _this3.getWallets();
            case 11:
              // Fetch the wallets associated with the selected owner
              // Check if the selected owner's wallets have only one country
              if (_this3.wallets.length === 1) {
                // If the wallets have only one country, automatically select that country
                _this3.country_id = _this3.wallets[0].country_id;

                // Also update governate and city if needed
                _this3.governate_id = _this3.wallets[0].governate_id;
                _this3.city_id = _this3.wallets[0].city_id;
              }
              _context.next = 17;
              break;
            case 14:
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.prev = 1;
              _context2.next = 4;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].get("/real-estate/owners");
            case 4:
              res = _context2.sent;
              owners = res.data.data;
              _this4.owners = owners;
              _context2.next = 12;
              break;
            case 9:
              _context2.prev = 9;
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.prev = 1;
              _context3.next = 4;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].get("/real-estate/buildings");
            case 4:
              res = _context3.sent;
              buildings = res.data.data;
              _this5.buildings = buildings;
              _context3.next = 12;
              break;
            case 9:
              _context3.prev = 9;
    ...
    getAllGovernorate: function getAllGovernorate() {
      var _this6 = this;
      return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
        var res, governorates;
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _context4.prev = 1;
              _context4.next = 4;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].get("/governorates");
            case 4:
              res = _context4.sent;
              governorates = res.data.data;
              _this6.governorates = governorates;
              _context4.next = 12;
              break;
            case 9:
              _context4.prev = 9;
        ...
        return _regeneratorRuntime().wrap(function _callee10$(_context10) {
          while (1) switch (_context10.prev = _context10.next) {
            case 0:
              ...
              _context10.prev = 1;
              _context10.next = 4;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].get("/countries");
            case 4:
              res = _context10.sent;
              countries = res.data.data;
              _this15.countries = countries;
              _context10.next = 12;
              break;
            case 9:
              _context10.prev = 9;
        ...
        return _regeneratorRuntime().wrap(function _callee11$(_context11) {
          while (1) switch (_context11.prev = _context11.next) {
            case 0:
              ...
              _this16.governorate_id = null;
              _this16.city_id = null;
              _context11.next = 5;
        ...
        return _regeneratorRuntime().wrap(function _callee12$(_context12) {
          while (1) switch (_context12.prev = _context12.next) {
            case 0:
              ...
              _this17.city_id = null;
              _context12.next = 4;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].get("/cities?country_id=".concat(_this17.country_id, "&governorate_id=").concat(governate_id)).then(function (res) {
                var l = res.data.data;
                _this17.cities = l;
              })["catch"](function (err) {
                sweetalert2__WEBPACK_IMPORTED_MODULE_6___default().fire({
        ...
        return _regeneratorRuntime().wrap(function _callee13$(_context13) {
          while (1) switch (_context13.prev = _context13.next) {
            case 0:
              ...
              _context13.prev = 1;
              _context13.next = 4;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_3__["default"].get("/real-estate/unit-type");
            case 4:
              res = _context13.sent;
              units = res.data.data;
              _this18.unit_ty = units;
              _context13.next = 12;
              break;
            case 9:
              _context13.prev = 9;
