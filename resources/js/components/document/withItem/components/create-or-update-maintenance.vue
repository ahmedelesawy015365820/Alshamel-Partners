 ...
 */
export default {
    name: "createOrUpdateMaintenance",
    props: {
        document: {
            default: null,
        },
    ...
    methods: {
        ...
        async resetModal() {
            ...
            if (this.other_data)
            {
                ...
                this.getRooms(0,this.other_data.date_from,this.other_data.date_to);
            }
            this.is_disabled = false;
            this.$nextTick(() => {
                this.$v.$reset();
        ...
        addRoomPrice(index)
        {
            if(this.create.header_details[index].unit_id)
            {
                ...
                let count_attendance = this.create.attendans_num + 1 ;
                if ((parseInt(count_attendance) + 1)  > room.price)
                {
        ...
        <b-modal dialog-class="modal-full-width" :id="id"
            ...
            <form>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <label class="control-label">{{ $t('general.employee') }} <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-12 col-lg-12">
                                        ...
                                        <div>
                                            <div
                                                ...
                                                <div class="col-2">{{ $t('general.MaintenanceDays') }}</div>
                                                <div class="col-2">{{ $t('general.to_date') }}</div>
                                                <div class="col-2">{{ $t('general.room') }}</div>
