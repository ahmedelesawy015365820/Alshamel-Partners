...
export default {
    ...
    props: {
        ...
        type: {default: 'create'}, idObjEdit: {default: null},isPermission: {},url: {default: '/recievable-payable/rp_main_contact_group'}
    },
    mounted(){
...
<template>
    ...
    <b-modal
        :id="id"
        :title="type != 'edit'?getCompanyKey('MainContactGroupsCreate'):getCompanyKey('MainContactGroupsEdit')"
        title-class="font-18"
        body-class="p-4 "
        :hide-footer="true"
        @show="resetModal"
