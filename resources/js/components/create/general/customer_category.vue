<template>
    ...
    <b-modal
        :id="id"
        :title="type != 'edit'?getCompanyKey('customer_category_create_form'):getCompanyKey('customer_category_edit_form')"
        title-class="font-18"
        body-class="p-4 "
        :hide-footer="true"
        @show="resetModal"
        ...
        <form>
            ...
            <div class="row">
                <div v-if="isVisible('name')" class="col-md-12">
                    <div class="form-group">
                        <label for="field-1" class="control-label">
                            {{ getCompanyKey("customer_category_name_ar") }}
                ...
                <div v-if="isVisible('name_e')" class="col-md-12">
                    <div class="form-group">
                        <label for="field-2" class="control-label">
                            {{ getCompanyKey("customer_category_name_en") }}
                ...
                <div
                    ...
                    v-if="isVisible('parent_id') && typeModel != 'main' && parentModel"
                >
                    <div class="form-group">
                        <label>
...
export default {
    ...
    props: {
        ...
        type: {default: 'create'}, idObjEdit: {default: null},isPermission: {},typeModel: {default: ''},
        parentModel: {default: null},url: {default: '/customers-categories'}
    },
    validations: {
        create: {
            name: {
    ...
    methods: {
        getParents(id) {
            this.isLoader = true;
             ...
             adminApi
                .get(`/customers-categories${id?'?dontId='+id:''}`)
                .then((res) => {
                    let l = res.data.data;
                    this.parent = l;
                })
        ...
        async getCustomTableFields() {
            this.isCustom = true;
            await adminApi
                .get(`/customTable/table-columns/general_customer_categories`)
                .then((res) => {
