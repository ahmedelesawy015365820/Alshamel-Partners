<template>
    ...
    <b-modal
        :id="id"
        :title="type != 'edit'?getCompanyKey('payment_method_create_form'):getCompanyKey('payment_method_edit_form')"
        title-class="font-18"
        body-class="p-4 "
        :hide-footer="true"
        @show="resetModal"
        ...
        <form>
            ...
            <div class="row">
                <div class="col-md-12" v-if="isVisible('name')">
                    <div class="form-group">
                        <label for="field-1" class="control-label">
                            {{ getCompanyKey("payment_method_name_ar") }}
                ...
                <div class="col-md-12" v-if="isVisible('name_e')">
                    <div class="form-group">
                        <label for="field-2" class="control-label">
                            {{ getCompanyKey("payment_method_name_en") }}
                ...
                <div class="col-md-12" v-if="isVisible('is_default')">
                    <div class="form-group">
                        <label class="mr-2">
                            {{ getCompanyKey("payment_method_default") }}
                            <span v-if="isRequired('is_default')" class="text-danger"
                            >*</span
                            >
                        </label>
                        <b-form-group
...
export default {
    ...
    methods: {
        getCustomTableFields() {
            this.isCustom = true;
            adminApi
                .get(`/customTable/table-columns/general_payment_methods`)
                .then((res) => {
        ...
        AddSubmit() {
            ...
            if (this.$v.create.$invalid) {
                ...
                if(this.type != 'edit'){
                    adminApi
                        .post(`/payment-methods`, { ...this.create, company_id: this.company_id })
                        .then((res) => {
                    ...
                    adminApi
                        .put(`/payment-methods/${this.idObjEdit.idEdit}`, {
                            ...this.create,
