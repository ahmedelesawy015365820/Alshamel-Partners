<template>
   <div>
       ...
       <b-modal
           :id="id"
           :title="type != 'edit'?getCompanyKey('variant_attributes_create_form'):getCompanyKey('variant_attributes_edit_form')"
           title-class="font-18"
           body-class="p-4 "
           :hide-footer="true"
           @show="resetModal"
                   ...
                   <div class="col-md-12" v-if="isVisible('name')">
                       <div class="form-group">
                           <label for="field-1" class="control-label">
                               {{ getCompanyKey('variant_attributes_name_ar') }}
                   ...
                   <div class="col-md-12" v-if="isVisible('name_e')">
                       <div class="form-group">
                           <label for="field-2" class="control-label">
                               {{ getCompanyKey('variant_attributes_name_en') }}
...
export default {
    ...
    props: {
        ...
        type: {default: 'create'}, idObjEdit: {default: null},isPermission: {},url: {default: '/attributes'}
    },
    data() {
        return {
            fields: [],
    ...
    methods: {
        getCustomTableFields() {
            this.isCustom = true;
            adminApi
                .get(`/customTable/table-columns/general_attributes`)
                .then((res) => {
