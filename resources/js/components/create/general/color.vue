<template>
    ...
    <b-modal
        :id="id"
        :title="type != 'edit'?getCompanyKey('color_create_form'):getCompanyKey('color_edit_form')"
        title-class="font-18"
        body-class="p-4 "
        :hide-footer="true"
        @show="resetModal"
...
export default {
    ...
    props: {
        ...
        type: {default: 'create'}, idObjEdit: {default: null},isPermission: {},url: {default: '/colors'}
    },
    data() {
        return {
            fields: [],
