<template>
  <div>
    ...
    <City
      ...
      :governorate_id="create.governorate_id"
      :country_id="create.country_id"
    />
    ...
    <b-modal
      ...
      :title="
        type != 'edit'
          ? getCompanyKey('avenue_create_form')
          : getCompanyKey('avenue_edit_form')
      "
      title-class="font-18"
      size="lg"
      body-class="p-4 "
    ...
    >
      <form>
        ...
        <div class="row">
          <div class="col-md-6" v-if="isVisible('country_id') && !country_id">
            <div class="form-group position-relative">
              <label class="control-label">
                ...
                <span v-if="isRequired('country_id')" class="text-danger"
                  >*</span
                >
              </label>
              <multiselect
          ...
          <div class="col-md-6" v-if="isVisible('governorate_id') && !governorate_id">
            <div class="form-group position-relative">
              <label class="control-label">
                ...
                <span v-if="isRequired('governorate_id')" class="text-danger"
                  >*</span
                >
              </label>
              <multiselect
          ...
          <div class="col-md-6" v-if="isVisible('city_id') && !city_id">
            <div class="form-group position-relative">
              <label class="control-label">
                {{ getCompanyKey("city") }}
      ...
      setTimeout( async () => {
        if (this.type != "edit") {
          ...
          if (this.idObjEdit.dataObj) {
            let avenue = this.idObjEdit.dataObj;
            this.errors = {};
            if (this.isVisible("country_id")) this.getCategory();
            if (this.isVisible("governorate_id"))
              this.getGovernorate(avenue.country.id);
            if (this.isVisible("city_id"))
              this.getCity(avenue.country.id, avenue.governorate.id);
            this.create.name = avenue.name;
            this.create.name_e = avenue.name_e;
            this.create.is_active = avenue.is_active;
            if (this.isVisible("country_id"))
              this.create.country_id = avenue.country.id;
            if (this.isVisible("city_id")) this.create.city_id = avenue.city.id;
            if (this.isVisible("governorate_id"))
              this.create.governorate_id = avenue.governorate.id;
          }
        }
      }, 50);
    },
