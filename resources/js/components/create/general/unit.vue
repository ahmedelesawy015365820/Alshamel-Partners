...
export default {
    ...
    props: {
        ...
        type: {default: 'create'}, idObjEdit: {default: null},isPermission: {},url: {default: '/units'}
    },
    data() {
        return {
            isCustom: false,
            ...
            setTimeout( () => {
                if(this.type != 'edit'){
                    ...
                    if(this.idObjEdit.dataObj){
                        ...
                        this.create.is_active = attribute.is_active;
                    }
                }
            },50);
        },
...
<template>
    <!--  create   -->
    <b-modal :id="id" :title="type != 'edit'?getCompanyKey('unit_create_form'):getCompanyKey('unit_edit_form')"
