<template>
   <div>
       ...
       <b-modal
           :id="id"
           :title="type != 'edit' ?getCompanyKey('group_create_form'):getCompanyKey('group_edit_form')"
           title-class="font-18"
           body-class="p-4 "
           :hide-footer="true"
           @show="resetModal"
...
export default {
    ...
    props: {
        ...
        type: {default: 'create'}, idObjEdit: {default: null},isPermission: {},url: {default: '/groups'}
    },
    data() {
        return {
            fields: [],
