...
export default {
    ...
    props: {
        ...
        type: {default: 'create'}, idObjEdit: {default: null},isPermission: {},url: {default: '/stores'}
    },
  components: {
    ErrorMessage,
    loader,
      ...
      setTimeout(async () => {
        if (this.type != "edit") {
          ...
          if (this.idObjEdit.dataObj) {
            ...
            this.create.branch_id = branch.branch_id ?? null;
            this.errors = {};
          }
        }
      }, 50);
...
<template>
  <div>
    ...
    <b-modal
      ...
      :title="
        type != 'edit'
          ? getCompanyKey('store_create_form')
          : getCompanyKey('store_edit_form')
      "
      title-class="font-18"
      body-class="p-4 "
      :hide-footer="true"
