<template>
   <div>
       ...
       <b-modal
           :id="id"
           :title="type != 'edit'?getCompanyKey('brand_create_form'):getCompanyKey('brand_edit_form')"
           title-class="font-18"
           body-class="p-4 "
           :hide-footer="true"
           @show="resetModal"
...
export default {
    ...
    props: {
        ...
        type: {default: 'create'}, idObjEdit: {default: null},isPermission: {},url: {default: '/brands'}
    },
    data() {
        return {
            fields: [],
