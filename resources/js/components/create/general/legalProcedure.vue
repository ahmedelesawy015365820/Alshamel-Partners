<template>
    ...
    <b-modal
        :id="id"
        :title="type != 'edit'?getCompanyKey('legal_procedure_create_form'):getCompanyKey('legal_procedure_edit_form')"
        title-class="font-18"
        body-class="p-4 "
        :hide-footer="true"
        @show="resetModal"
                ...
                <div class="col-md-12" v-if="isVisible('name')">
                    <div class="form-group">
                        <label for="field-1" class="control-label">
                            {{ getCompanyKey("legal_procedure_name_ar") }}
                ...
                <div class="col-md-12" v-if="isVisible('name_e')">
                    <div class="form-group">
                        <label for="field-2" class="control-label">
                            {{ getCompanyKey("legal_procedure_name_en") }}
...
export default {
    ...
    props: {
        ...
        type: {default: 'create'}, idObjEdit: {default: null},isPermission: {},url: {default: '/legal-procedures'}
    },
    data() {
        return {
            fields: [],
    ...
    methods: {
        getCustomTableFields() {
            this.isCustom = true;
            adminApi
                .get(`/customTable/table-columns/general_legal_procedures`)
                .then((res) => {
            ...
            setTimeout( () => {
                if(this.type != 'edit'){
                    ...
                    if(this.idObjEdit.dataObj){
                        ...
                        this.create.is_active = color.is_active;
                    }
                }
            },50);
        },
