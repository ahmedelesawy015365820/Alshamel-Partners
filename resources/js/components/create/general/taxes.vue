<template>
   <div>
       ...
       <b-modal
           :id="id"
           :title="type != 'edit'?getCompanyKey('taxes_create_form'):getCompanyKey('taxes_edit_form')"
           title-class="font-18"
           body-class="p-4 "
           :hide-footer="true"
           @show="resetModal"
           ...
           <form>
               ...
               <div class="row">
                   ...
                   <div class="col-md-12" v-if="isVisible('name_e')">
                       <div class="form-group">
                           <label class="control-label">
                               {{ getCompanyKey("taxes_name_en") }}
                               <span v-if="isRequired('name_e')" class="text-danger">*</span>
                           </label>
                           <div dir="ltr">
                               <input
                                   @keyup="englishValue(create.name_e)" type="text"
                   ...
                   <div class="col-md-12" v-if="isVisible('percentage')">
                       <div class="form-group">
                           <label class="mr-2">
                               {{ getCompanyKey("taxes_percentage") }}
                               <span v-if="isRequired('percentage')" class="text-danger">*</span>
                           </label>
                           <input
                               type="number"
                               step="any"
                               ...
                               :class="{
                                                    ...
                                                    'is-valid': !$v.create.percentage.$invalid && !errors.percentage,
                                                }"
                           />
                           <template v-if="errors.percentage">
                               <ErrorMessage v-for="(errorMessage, index) in errors.percentage" :key="index">
                                   {{ errorMessage }}
                               </ErrorMessage>
                           </template>
                       </div>
...
export default {
    ...
    props: {
        ...
        type: {default: 'create'}, idObjEdit: {default: null},isPermission: {},url: {default: '/taxes'}
    },
    data() {
        return {
            fields: [],
    ...
    methods: {
        getCustomTableFields() {
            this.isCustom = true;
            adminApi
                .get(`/customTable/table-columns/general_taxes`)
                .then((res) => {
            ...
            setTimeout( () => {
                if(this.type != 'edit'){
                    ...
                    if(this.idObjEdit.dataObj){
                        ...
                        this.create.percentage = attribute.percentage;
                        this.create.is_default = attribute.is_default;
                    }
                }
            },50);
        },
