<template>
    <div>
        ...
        <b-modal
            :id="id"
            :title="type != 'edit' ?getCompanyKey('club_statuses_create_form'):getCompanyKey('club_statuses_edit_form')"
            title-class="font-18"
            body-class="p-4 "
            :hide-footer="true"
            @show="resetModal"
                    ...
                    <div class="col-md-12" v-if="isVisible('name')">
                        <div class="form-group">
                            <label for="field-1" class="control-label">
                                {{ getCompanyKey("club_statuses_name_ar") }}
                    ...
                    <div class="col-md-12" v-if="isVisible('name_e')">
                        <div class="form-group">
                            <label for="field-2" class="control-label">
                                {{ getCompanyKey("club_statuses_name_en") }}
...
export default {
    ...
    props: {
        ...
        type: {default: 'create'}, idObjEdit: {default: null},isPermission: {},url: {default: '/club-members/cm-status'}
    },
    data() {
        return {
            fields: [],
