...
export default {
    name: "BookingGuest",
  props: {
        id: {default: "guest-create",}, companyKeys: {default: [],}, defaultsKeys: {default: [],},
  ...
  validations: {
    create: {
        ...
        passport_expiry_date: {
            required: requiredIf(function (model) {
                return this.isRequired("passport_expiry_date");
            }),
        },
        visa_no: {
            required: requiredIf(function (model) {
                return this.isRequired("visa_no");
            }),
            integer,
            maxLength: maxLength(40),
        },
      ...
      setTimeout(async () => {
            if(this.type != 'edit'){
                ...
                if(this.idObjEdit.dataObj){
                    ...
                    this.create.nationality = build.nationality;
                    this.create.passport_no = build.passport_no;
                    this.create.passport_expiry_date = build.passport_expiry_date;
                    this.create.visa_no = build.visa_no;
                    this.create.phone = build.phone;
                    this.create.email = build.email;
                    this.create.id_number = build.id_number;
...
<!--    />-->
    ...
    <b-modal
      :id="id"
      :title="type != 'edit'?getCompanyKey('guest_create_form'):getCompanyKey('guest_edit_form')"
      title-class="font-18"
          ...
          <b-tabs nav-class="nav-tabs nav-bordered">
              <b-tab :title="$t('general.DataEntry')" active>
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-3" v-if="isVisible('id_number')">
                          <div class="form-group">
                              <label class="control-label">
                                  {{ getCompanyKey("guest_id_number") }}
                                  <span v-if="isRequired('id_number')" class="text-danger">*</span>
                              </label>
                              <input
                                  type="text"
                                  class="form-control"
                                  ...
                                  :class="{
                                    'is-invalid': $v.create.id_number.$error || errors.id_number,
                                    'is-valid':!$v.create.id_number.$invalid &&!errors.id_number,
                                  }"
                              />
                              <template v-if="errors.id_number">
                                  <ErrorMessage v-for="(errorMessage, index) in errors.id_number" :key="index">
                                      {{ errorMessage }}
                                  </ErrorMessage>
                              </template>
                          </div>
                      ...
                      <div class="col-md-3" v-if="isVisible('address')">
                          <div class="form-group">
                              ...
                              <template v-if="errors.address">
                                  <ErrorMessage v-for="(errorMessage, index) in errors.address" :key="index">
                                      {{ errorMessage }}
                                  </ErrorMessage>
                              </template>
                          </div>
                  ...
                  <hr v-if="
                          ...
                          isVisible('passport_expiry_date') ||
                          isVisible('visa_no')
                        "
                      style="
                          margin: 10px 0 !important;
                  ...
                  <div class="row">
                      <div class="col-md-3" v-if="isVisible('nationality')">
                          <div class="form-group">
                              <label class="control-label">
                                  {{ getCompanyKey("guest_nationality")}}
                      ...
                      <div class="col-md-3" v-if="isVisible('passport_no')">
                          <div class="form-group">
                              <label class="control-label">
                                  {{getCompanyKey( "guest_passport_number")}}
                      ...
                      <div class="col-md-3" v-if="isVisible('passport_expiry_date')">
                          <div class="form-group">
                              <label class="control-label">
                                  {{ getCompanyKey("guest_passport_expiration_date")}}
                                  <span v-if="isRequired('passport_expiry_date')" class="text-danger">*</span>
                              </label>
                              <date-picker
                                  type="date"
                                  v-model="create.passport_expiry_date"
                                  format="YYYY-MM-DD"
                                  valueType="format"
                                  :confirm="false"
                                  :class="{
                                    'is-invalid': $v.create.passport_expiry_date.$error || errors.passport_expiry_date,
                                    'is-valid':!$v.create.passport_expiry_date.$invalid && !errors.passport_expiry_date,
                                  }"
                              ></date-picker>
                              <template v-if="errors.passport_expiry_date">
                                  <ErrorMessage v-for="( errorMessage, index ) in errors.passport_expiry_date" :key="index">
                                      {{ errorMessage }}
                                  </ErrorMessage>
                              </template>
                          </div>
                      </div>
                      <div class="col-md-3" v-if="isVisible('visa_no')">
                          <div class="form-group">
                              <label class="control-label">
                                  {{getCompanyKey( "guest_visa_number")}}
                                  <span v-if="isRequired('visa_no')" class="text-danger">*</span>
                              </label>
                              <input
                                  type="number"
                                  class="form-control"
                                  step="0.1"
                                  v-model="$v.create.visa_no.$model"
                                  :class="{
                                    'is-invalid': $v.create.visa_no.$error || errors.visa_no,
                                    'is-valid': !$v.create.visa_no.$invalid && !errors.visa_no,
                                  }"
                              />
                              <template v-if="errors.visa_no">
                                  <ErrorMessage v-for="(errorMessage, index) in errors.visa_no" :key="index">
                                      {{ errorMessage }}
                                  </ErrorMessage>
                              </template>
                          </div>
