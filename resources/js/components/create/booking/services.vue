<template>
    <div>
        ...
        <b-modal
            :id="id"
            :title="type != 'edit'?getCompanyKey('service_create_form'):getCompanyKey('service_edit_form')"
            title-class="font-18"
            body-class="p-4 "
            :hide-footer="true"
            @show="resetModal"
        ...
        >
            <form>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12" v-if="isVisible('type')">
                        <div class="form-group">
                            <label class="control-label">
                                {{ getCompanyKey("service_type") }}
                            ...
                            <template v-if="errors.type">
                                <ErrorMessage v-for="(errorMessage, index) in errors.type" :key="index">{{ errorMessage }}</ErrorMessage>
                            </template>
                        </div>
                    </div>
                </div>
...
export default {
    ...
    props: {
        ...
        type: {default: 'create'}, idObjEdit: {default: null},isPermission: {},url: {default: '/General-item'}
    },
    data() {
        return {
            fields: [],
    ...
    methods: {
        getCustomTableFields() {
            this.isCustom = true;
            adminApi
                .get(`/customTable/table-columns/general_items`)
                .then((res) => {
