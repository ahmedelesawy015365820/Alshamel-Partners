            ...
            <div class="card">
                <div class="card-body">
                    <div class="row justify-content-between align-items-center mb-2">
                        <h4 class="header-title">{{ $t("general.reservationTable") }}</h4>
                    ...
                    <!--  create   -->
                    <b-modal dialog-class="modal-full-width" id="create" :title="getCompanyKey('reservation_create_form')"
                            ...
                            <tr @click.capture="checkRow(data.id)"
                                ...
                                <td v-if="enabled3" class="do-not-print">
                                    ...
                                    <b-modal dialog-class="modal-full-width" :id="`modal-edit-${data.id}`"
                                             :title="getCompanyKey('reservation_edit_form')" title-class="font-18"
...
export default {
    ...
    methods: {
        ...
        changeValue(index){
            ...
            let sum = 0;
            this.create.details.forEach(e => e.unit_value ? sum += e.unit_value : null);
            this.total = sum;
        },
        changeValueEdit(index){
            ...
            let sum = 0;
            this.edit.details.forEach(e => e.unit_value ? sum += e.unit_value : null);
            this.total = sum;
        },
        addNewField(){
        ...
        async getUnits(buildingId, index = null) {
            if (buildingId == 0) {
        ...
        async resetModalEdit(id) {
            ...
            // this.getBranchSerial(reservation.branch.id);
            if (this.images && this.images.length > 0) {
                this.showPhoto = this.images[this.images.length - 1].webp;
            } else {
                this.showPhoto = "./images/img-1.png";
