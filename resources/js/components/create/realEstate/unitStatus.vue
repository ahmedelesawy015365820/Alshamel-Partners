<template>
    ...
    <b-modal
        :id="id"
        :title="type != 'edit'?getCompanyKey('unitstatus_create_form'):getCompanyKey('unitstatus_edit_form')"
...
export default {
    ...
    props: {
        ...
        ,url: {default: '/real-estate/unit-statuses'}
    },
    mounted() {
    ...
    methods: {
        async getCustomTableFields() {
            this.isCustom = true;
            await adminApi
                .get(`/customTable/table-columns/rlst_unit_statuses`)
                .then((res) => {
