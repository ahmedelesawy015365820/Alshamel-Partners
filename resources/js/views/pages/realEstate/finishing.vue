...
import Finishing from "../../../components/create/realEstate/finishing.vue";
...
export default {
  page: {
    title: "Finishing",
    meta: [{ name: "description", content: "Finishing" }],
  },
  mixins: [translation, customTable, successError, crudHelper],
  beforeRouteEnter(to, from, next) {
    next((vm) => {
      return permissionGuard(vm, "Finishing", "all Finishing");
    });
  },
  components: {
    Layout,
        ...
        <div class="card">
          <div class="card-body">
            ...
            <actionSetting
              ...
              :isEdit="true"
              :isDelete="true"
              :permissionCreate="isPermission('create Finishing')"
              :permissionUpdate="isPermission('update Finishing')"
              :permissionDelete="isPermission('delete Finishing')"
              :isExcl="true"
              :isPrint="true"
              :checkAll="checkAll"
              :sideAction="true"
