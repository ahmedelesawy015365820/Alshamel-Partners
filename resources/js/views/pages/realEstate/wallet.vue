...
export default {
    ...
    components: {
        Layout, PageHeader, loader, Wallet,
    ...
    data() {
        return {
            url: '/real-estate/wallets',
            searchMain: '',
            tableSetting: [
                {
                    isFilter: true,isSet: true,trans:"wallet_name_ar",isV: 'name',
                    type: 'string',sort: true,setting: {"name":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"wallet_name_en",isV: 'name_e',
    ...
    mounted() {
        ...
        this.settingFun();
        this.getCustomTableFields('rlst_wallets');
