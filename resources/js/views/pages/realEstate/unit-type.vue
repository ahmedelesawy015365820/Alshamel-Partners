...
export default {
  page: {
    title: "Unit type",
    meta: [{ name: "description", content: "Unit type" }],
  },
  ...
  data() {
    return {
        ...
        tableSetting: [
            {
                isFilter: true,isSet: true,trans:"unit_type_name_ar",isV: 'name',
                type: 'string',sort: true,setting: {"name":true},isSetting: true
            },
            {
                isFilter: true,isSet: true,trans:"unit_type_name_en",isV: 'name_e',
