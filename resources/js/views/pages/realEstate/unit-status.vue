...
export default {
  ...
  data() {
    return {
        ...
        tableSetting: [
            {
                isFilter: true,isSet: true,trans:"unitstatus_name_ar",isV: 'name',
                type: 'string',sort: true,setting: {"name":true},isSetting: true
            },
            {
                isFilter: true,isSet: true,trans:"unitstatus_name_en",isV: 'name_e',
                type: 'string',sort: true,setting: {"name_e":true},isSetting: true
            },
            {
                isFilter: false,isSet: true,trans:"unitstatus_status",isV: 'is_active',
                type: 'boolean',setting: {"is_active":true},isSetting: true
            },
            {
                isFilter: false,isSet: true,trans:"unitstatus_default",isV: 'is_default',
        ...
        <div class="card">
          <div class="card-body">
              ...
              <actionSetting
                  ...
                  :permissionCreate="isPermission('create unit_status RealState')"
                  :permissionUpdate="isPermission('update unit_status RealState')"
                  :permissionDelete="isPermission('delete unit_status RealState')" :isExcl="true"
            ...
            >
              ...
              <!--       end loader       -->
                ...
                <tableCustom
                    ...
                    :permissionUpdate="isPermission('update unit_status RealState')"
                    :permissionDelete="isPermission('delete unit_status RealState')"
