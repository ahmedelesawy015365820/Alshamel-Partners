...
import SellMethod from "../../../components/create/boardRent/sell-methods.vue";
...
export default {
  ...
  beforeRouteEnter(to, from, next) {
    next((vm) => {
      return permissionGuard(vm, "Sell method", "all Sell method");
    });
  },
  components: {
    Layout,
        ...
        <div class="card">
          <div class="card-body">
            ...
            <actionSetting
              ...
              :isEdit="true"
              :isDelete="true"
              :permissionCreate="isPermission('create Sell Method')"
              :permissionUpdate="isPermission('update Sell Method')"
              :permissionDelete="isPermission('delete Sell Method')"
              :isExcl="true"
              :isPrint="true"
              :checkAll="checkAll"
              :sideAction="true"
