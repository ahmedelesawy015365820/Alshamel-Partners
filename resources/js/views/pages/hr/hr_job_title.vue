  ...
  methods: {
    ...
    getData(page = 1) {
      ...
      adminApi
        ...
        .then((res) => {
          let l = res.data;
          this.jobTitles = l.data;
          this.jobTitlesPagination = l.pagination;
    ...
    getDataCurrentPage(page = 1) {
      if (
        this.current_page <= this.jobTitlesPagination.last_page &&
        this.current_page != this.jobTitlesPagination.current_page &&
        this.current_page
      ) {
        this.isLoader = true;
        let filter = "";
      ...
      if (Array.isArray(id)) {
        Swal.fire({
          ...
          if (result.value) {
            this.isLoader = true;
            adminApi
              .post(`/hr/job-title/bulk-delete`, { ids: id })
              .then((res) => {
                this.checkAll = [];
                this.getData();
                Swal.fire({
     ...
     */
    resetModalEdit(id) {
      let jobTitles = this.jobTitles.find((e) => id == e.id);
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="row justify-content-between align-items-center mb-2">
              <h4 class="header-title">{{ $t("general.jobTitlesTable") }}</h4>
                ...
                <div class="d-fex">
                  ...
                  >
                    <div class="d-inline-block" style="font-size: 13px">
                      {{ jobTitlesPagination.from }}-{{
                        jobTitlesPagination.to
                      }}
                      /
                      {{ jobTitlesPagination.total }}
                    </div>
                    <div class="d-inline-block">
                      <a
                        href="javascript:void(0)"
                      ...
                      <a
                        ...
                        :style="{
                          'pointer-events':
                            jobTitlesPagination.last_page ==
                            jobTitlesPagination.current_page
                              ? 'none'
                              : '',
                        }"
                        @click.prevent="
                      ...
                      <div class="d-flex justify-content-center">
                        ...
                        <div class="arrow-sort">
                          <i
                            ...
                            @click="jobTitles.sort(sortString('name'))"
                          ></i>
                          <i
                    ...
                    <th v-if="setting.name_e">
                      <div class="d-flex justify-content-center">
                        ...
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                            @click="jobTitles.sort(sortString('name_e'))"
                          ></i>
                          <i
                            class="fas fa-arrow-down"
                            @click="jobTitles.sort(sortString('-name_e'))"
                  ...
                  >
                    ...
                    <td v-if="enabled3" class="do-not-print">
                      ...
                      <b-modal
                        ...
                        :title="getCompanyKey('job_title_edit_form')"
                        title-class="font-18"
                        body-class="p-4"
                        :ref="`edit-${data.id}`"
                        :hide-footer="true"
