...
import TimeTableAttendance from "../../../components/create/hr/time-table-attendance";
 ...
 */
export default {
    page: {title: "time Table Attendance", meta: [{ name: "description", content: "time Table Attendance" }],},
    mixins: [translation,customTable,successError,crudHelper],
    beforeRouteEnter(to, from, next) {
        next((vm) => {
            return permissionGuard(vm, "Time Attendance", "all timeAttendance hr");
        });
    },
    components: {
    ...
    data() {
        return {
            ...
            tableSetting: [
                {
                    isFilter: true,isSet: true,trans:"attendance_times_name_ar",isV: 'name',
                    type: 'string',sort: true,setting: {"name":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"attendance_times_name_en",isV: 'name_e',
                    type: 'string',sort: true,setting: {"name_e":true},isSetting: true
                },
                {
                    isFilter: false,isSet: true,trans:"attendance_times_tt_type",isV: 'timetable_types_id',
                    type: 'relation',setting: {"timetable_types_id":true},isSetting: true,name: 'TimeTableType',
                    col1: 'name',col2: 'name_e'
                },
                {
                    isFilter: false,isSet: true,trans:"attendance_times_tt_monthly_hours",isV: 'tt_monthly_hours',
                    type: 'string',setting: {"tt_monthly_hours":true},isSetting: true
                }
            ],
            sendSetting: {},
            searchField: []
