...
import InstallmentStatus from "../../../components/create/receivablePayment/installmentStatus.vue";
        ...
        <div class="card">
          <div class="card-body">
            ...
            <actionSetting
              ...
              :isEdit="true"
              :isDelete="true"
              :permissionCreate="isPermission('create installmentStatus RP')"
              :permissionUpdate="isPermission('update installmentStatus RP')"
              :permissionDelete="isPermission('delete installmentStatus RP')"
              :isExcl="true"
              :isPrint="true"
              :checkAll="checkAll"
              :sideAction="true"
