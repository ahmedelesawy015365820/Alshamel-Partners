...
import InstallmentPaymentType from "../../../components/create/receivablePayment/installmentPaymentType";
...
export default {
    ...
    components: {
        Layout, PageHeader,loader, InstallmentPaymentType,
        searchPage,actionSetting, tableCustom
    },
    beforeRouteEnter(to, from, next) {
    next((vm) => {
        return permissionGuard(vm, "Installment Payment Type", "all paymentType RP");
    });
    },
    data() {
        return {
            ...
            tableSetting: [
                {
                    isFilter: true,isSet: true,trans:"installment_payment_type_name",isV: 'name',
                    type: 'string',sort: true,setting: {"name":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"installment_payment_type_name_e",isV: 'name_e',
                    type: 'string',sort: true,setting: {"name_e":true},isSetting: true
                },
                {
                    isFilter: false,isSet: true,trans:"is_passed",isV: 'is_passed',
                    type: 'boolean',setting: {"is_passed":true},isSetting: true
                },
                {
                    isFilter: false,isSet: true,trans:"installment_payment_is_partially",isV: 'is_partially',
        ...
        <div class="card">
          <div class="card-body">
              ...
              <actionSetting
                  ...
                  :permissionCreate="isPermission('create paymentType RP')"
                  :permissionUpdate="isPermission('update paymentType RP')"
                  :permissionDelete="isPermission('delete paymentType RP')" :isExcl="true"
            ...
            >
              ...
              <!--       end loader       -->
                ...
                <tableCustom
                    ...
                    :permissionUpdate="isPermission('update paymentType RP')"
                    :permissionDelete="isPermission('delete paymentType RP')"
