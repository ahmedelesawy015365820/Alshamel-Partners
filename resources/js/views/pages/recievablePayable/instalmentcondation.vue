...
import InstallmentCondition from "../../../components/create/receivablePayment/installmentCondition";
...
export default {
    ...
    components: {
        Layout, PageHeader,loader, InstallmentCondition,
        searchPage,actionSetting, tableCustom
    },
    beforeRouteEnter(to, from, next) {
        next((vm) => {
            return permissionGuard(vm, "Condition RP", "all condition RP");
        });
    },
    data() {
        return {
            ...
            tableSetting: [
                {
                    isFilter: true,isSet: true,trans:"installment_condition_name",isV: 'name',
                    type: 'string',sort: true,setting: {"name":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"installment_condition_name_e",isV: 'name_e',
                    type: 'string',sort: true,setting: {"name_e":true},isSetting: true
                },
                {
                    isFilter: false,isSet: true,trans:"installment_condition_default",isV: 'is_default',
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <actionSetting
                            ...
                            :permissionCreate="isPermission('create condition RP')"
                            :permissionUpdate="isPermission('update condition RP')"
                            :permissionDelete="isPermission('delete condition RP')" :isExcl="true"
                        ...
                        >
                            ...
                            <tableCustom
                                ...
                                :permissionUpdate="isPermission('update condition RP')"
                                :permissionDelete="isPermission('delete condition RP')"
