...
import InstallmentPlan from "../../../components/create/receivablePayment/installmentPlan";
...
export default {
      page: {
        ...
        meta: [{ name: "Installment Payment Plan", content: "Installment Payment Plan" }],
      },
      mixins: [translation,customTable,successError,crudHelper],
      components: {
          Layout, PageHeader,loader, InstallmentPlan,
          searchPage,actionSetting, tableCustom
      },
      beforeRouteEnter(to, from, next) {
        next((vm) => {
            return permissionGuard(vm, "Payment Plan RP", "all paymentPlan RP");
        });
      },
      data() {
         return {
             ...
             tableSetting: [
                 {
                     isFilter: true,isSet: true,trans:"installment_payment_name_ar",isV: 'name',
                     type: 'string',sort: true,setting: {"name":true},isSetting: true
                 },
                 {
                     isFilter: true,isSet: true,trans:"installment_payment_name_en",isV: 'name_e',
                     type: 'string',sort: true,setting: {"name_e":true},isSetting: true
                 },
                 {
                     isFilter: false,isSet: true,trans:"installment_payment_description_ar",isV: 'description',
                     type: 'string',sort: true,setting: {"description":true},isSetting: true
                 },
                 {
                     isFilter: false,isSet: true,trans:"installment_payment_description_en",isV: 'description_e',
                     type: 'string',sort: true,setting: {"description_e":true},isSetting: true
                 },
                 {
                     isFilter: false,isSet: true,trans:"is_active",isV: 'is_active',
                     type: 'boolean',setting: {"is_active":true},isSetting: true
                 },
                 {
                     isFilter: false,isSet: true,trans:"is_default",isV: 'is_default',
        ...
        <div class="card">
          <div class="card-body">
              ...
              <actionSetting
                  ...
                  :permissionCreate="isPermission('create paymentPlan RP')"
                  :permissionUpdate="isPermission('update paymentPlan RP')"
                  :permissionDelete="isPermission('delete paymentPlan RP')" :isExcl="true"
            ...
            >
              ...
              <!--       end loader       -->
                ...
                <tableCustom
                    ...
                    :permissionUpdate="isPermission('update paymentPlan RP')"
                    :permissionDelete="isPermission('delete paymentPlan RP')"
