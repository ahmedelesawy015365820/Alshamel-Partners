...
export default {
  page: {
    ...
    meta: [{ name: "Main Contact Groups", content: "Main Contact Groups" }],
  },
  beforeRouteEnter(to, from, next) {
    next((vm) => {
        return permissionGuard(vm, "Main Contact Group", "all Store");
    });
  },
  mixins: [translation,customTable,successError,crudHelper],
  components: {
        Layout, PageHeader,loader, MainContactGroup,
  ...
  data() {
    return {
        ...
        tableSetting: [
            {
                isFilter: true,isSet: true,trans:"Group_name",isV: 'name',
                type: 'string',sort: true,setting: {"name":true},isSetting: true
            },
            {
                isFilter: true,isSet: true,trans:"Group_name_e",isV: 'name_e',
        ...
        <div class="card">
          <div class="card-body">
              ...
              <actionSetting
                  ...
                  :permissionCreate="isPermission('create mainGroup RP')"
                  :permissionUpdate="isPermission('update mainGroup RP')"
                  :permissionDelete="isPermission('delete mainGroup RP')" :isExcl="true"
            ...
            <div class="table-responsive mb-3 custom-table-theme position-relative" ref="exportable_table"
              ...
              <!--       end loader       -->
                <tableCustom
                    ...
                    :permissionUpdate="isPermission('update mainGroup RP')"
                    :permissionDelete="isPermission('delete mainGroup RP')"
