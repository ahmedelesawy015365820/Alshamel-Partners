...
export default {
    ...
    methods: {
        ...
        getData(page = 1) {
            ...
            adminApi
                .get(
                    `real-estate/invoices?voucher=true&module_type=credit&page=${page}&per_page=${this.per_page}&search=${this.search}&${filter}`
                )
                .then((res) => {
                    let l = res.data;
        ...
        getDataCurrentPage() {
            if (
                ...
                adminApi
                    .get(
                        `real-estate/invoices?voucher=true&module_type=credit&page=${this.current_page}&per_page=${this.per_page}&search=${this.search}&${filter}`
                    )
                    .then((res) => {
                        let l = res.data;
                        this.invoices = l.data;
                                                                    ...
                                                                    <div class="table-responsive mb-3 custom-table-theme position-relative">
                                                                        ...
                                                                        <table class="table table-borderless table-hover table-centered m-0" >
                                                                            ...
                                                                            >
                                                                                ...
                                                                                <td>
                                                                                    <h5 class="m-0 font-weight-normal">{{$t(`general.${data.break_type}`)}}</h5>
                                                                                </td>
                                                                                <td>
