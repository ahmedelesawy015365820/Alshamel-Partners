...
export default {
    page: {
        title: "member reject",
        meta: [{name: "description", content: "member reject"}],
    },
    mixins: [translation],
    components: {
        Layout,
    ...
    beforeRouteEnter(to, from, next) {
            next((vm) => {
      return permissionGuard(vm, "member reject", "all member reject club");
    });
    },
    data() {
        return {
    ...
    validations: {
        create: {
            ...
            session_number: {required: requiredIf(function (model) {
    ...
    methods: {
        ...
        async getSerials() {
            this.isLoader = true;
            await adminApi
                .get(`/serials?branch_id=${this.create.branch_id}&document_id=37`)
                .then((res) => {
                    this.isLoader = false;
                    let l = res.data.data;
                    this.serials = l;
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row justify-content-between align-items-center mb-2">
                            <h4 class="header-title">{{ $t("general.memberRejectTable") }}</h4>
...
<!--                                    </button>-->
                        ...
                        <b-modal
                            id="create"
                            :title="getCompanyKey('member_reject_create_form')"
                            title-class="font-18"
                            body-class="p-4 "
                            size="lg"
                            :hide-footer="true"
                                ...
                                <div class="row">
                                    <div class="col-md-6" v-if="isVisible('branch_id')">
                                        <div class="form-group">
                                            <label>{{ getCompanyKey("member_reject_branch") }}</label>
                                    ...
                                    <div class="col-md-6" v-if="isVisible('serial_id')">
                                        <div class="form-group">
                                            <label>{{ getCompanyKey("member_reject_Serial_Number") }}</label>
                                    ...
                                    <div class="col-md-6" v-if="isVisible('session_number')">
                                        <div class="form-group">
                                            <label  class="control-label">
                                                {{ getCompanyKey("member_reject_session_number") }}
                                                <span v-if="isRequired('session_number')" class="text-danger">*</span>
                                            </label>
                                            <input
                                                type="text"
                                                class="form-control"
                                                v-model="$v.create.session_number.$model"
                                                :class="{
                                                  'is-invalid': $v.create.session_number.$error || errors.session_number,
                                                  'is-valid':
                                                    !$v.create.session_number.$invalid && !errors.session_number,
                                                }"
                                            />
