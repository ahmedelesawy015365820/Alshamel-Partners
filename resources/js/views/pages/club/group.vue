...
import GroupClub from "../../../components/create/club/group";
...
export default {
    ...
    components: {
        ...
        actionSetting, tableCustom, GroupClub
    },
    beforeRouteEnter(to, from, next) {
        next((vm) => {
            return permissionGuard(vm, "Group Club", "all Group");
        });
    },
    data() {
        return {
            ...
            tableSetting: [
                {
                    isFilter: true,isSet: true,trans:"club_group_name_ar",isV: 'name',
                    type: 'string',sort: true,setting: {"name":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"club_group_name_en",isV: 'name_e',
