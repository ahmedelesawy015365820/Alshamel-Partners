...
import FinancialStatus from "../../../components/create/club/financialStatus";
...
export default {
    ...
    components: {
        ...
        actionSetting, tableCustom, FinancialStatus
    },
    data() {
        return {
            ...
            tableSetting: [
                {
                    isFilter: true,isSet: true,trans:"financial_status_name_ar",isV: 'name',
                    type: 'string',sort: true,setting: {"name":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"financial_status_name_en",isV: 'name_e',
    ...
    methods: {
        filterSearch(fields){
            let indexC = fields.indexOf("group_id"),
                filter = '';
            if (indexC > -1) {
                    ...
                    <div class="card-body">
                        ...
                        >
                            ...
                            <tableCustom
                                ...
                                :isInputCheck="false" :isLog="true" :isAction="false"
                            />
