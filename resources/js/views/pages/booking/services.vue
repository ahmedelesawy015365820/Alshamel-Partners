...
import Services from "../../../components/create/booking/services";
...
export default {
    ...
    components: {
        ...
        actionSetting, tableCustom, Services
    },
    beforeRouteEnter(to, from, next) {
        next((vm) => {
            return permissionGuard(vm, "Booking Services", "all items");
        });
    },
    data() {
        return {
            ...
            tableSetting: [
                {
                    isFilter: true,isSet: true,trans:"service_name_ar",isV: 'name',
                    type: 'string',sort: true,setting: {"name":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"service_name_en",isV: 'name_e',
                    type: 'string',sort: true,setting: {"name_e":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"service_price",isV: 'price',
                    type: 'string',sort: true,setting: {"price":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"service_type",isV: 'type',
