...
import Company from "../../../components/create/booking/company";
/**
...
export default {
    ...
    components: {
        Layout, PageHeader, Company,loader,
        searchPage,actionSetting, tableCustom
    },
    data() {
        return {
            url: '/general-customer?type=0',
            searchMain: '',
            tableSetting: [
                {
                    isFilter: true,isSet: true,trans:"company_name_ar",isV: 'name',
                    type: 'string',sort: true,setting: {"name":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"company_name_en",isV: 'name_e',
                    type: 'string',sort: true,setting: {"name_e":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"company_employee",isV: 'employee_id',
                    type: 'relation', name:'employee',sort: false,col1: 'name',col2: 'name_e',
                    setting: {"employee_id":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"company_phone",isV: 'phone',
                    type: 'string',sort: true,setting: {"phone":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"company_email",isV: 'email',
                    type: 'string',sort: true,setting: {"email":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"company_tax_record",isV: 'tax_record',
                    type: 'string',sort: true,setting: {"tax_record":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"company_address",isV: 'address',
                    type: 'string',sort: true,setting: {"address":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"comapny_contact_person",isV: 'contact_person',
                    type: 'string',sort: true,setting: {"contact_person":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"comapny_contact_phones",isV: 'contact_phone',
