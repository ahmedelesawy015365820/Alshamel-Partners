 ...
 */
export default {
  page: {title: "items report", meta: [{ name: "items report", content: "items report" }],},
  mixins: [translation,customTable,successError,crudHelper],
  beforeRouteEnter(to, from, next) {
    next((vm) => {
      return permissionGuard(vm, "items report", "all items report");
    });
  },
  components: {
  ...
  data() {
    return {
      ...
      tableSetting: [
          {
              isFilter: false,isSet: true,trans:"items_report_serial_number", isV: 'prefix',
              type: 'relation',name: 'document_header',sort: false,col1: 'prefix',col2: 'prefix',
              setting: {"prefix":true},isSetting: true
          },
          {
              isFilter: false,isSet: true,trans:"items_report_customer", isV: 'customer_id'
          ...
          {
              isFilter: false,isSet: true,trans:"items_report_date",isV: 'date_from',
              type: 'date',sort: true,setting: {"date_from":true},isSetting: true
          },
          {
              isFilter: false,isSet: true,trans:"items_report_item",isV: 'item_id',
              type: 'relation', name:'item',sort: false,col1: 'name',col2: 'name_e',
              setting: {"item_id":true},isSetting: true
          },
          {
              isFilter: false,isSet: true,trans:"items_report_quantity",isV: 'quantity',
              type: 'string',setting: {"quantity":true},isSetting: true
          },
          {
              isFilter: false,isSet: true,trans:"items_report_price_per_day",isV: 'price_per_uint',
              type: 'string',setting: {"price_per_uint":true},isSetting: true
          },
          {
              isFilter: false,isSet: true,trans:"items_report_total",isV: 'total',
              type: 'string',setting: {"total":true},isSetting: true
          },
          {
              isFilter: false,isSet: true,trans:"items_report_discount",isV: 'discount',
  ...
  methods: {
    settingFun(setting = null){
      ...
      filterDataApi()
      {
          this.getData(1,this.url+`?document_id=36&date_from=${this.create.start_date}&date_to=${this.create.end_date}&customer_id=${this.create.customer_id ? this.create.customer_id:''}&`,'');
      }
  }
};
</script>
