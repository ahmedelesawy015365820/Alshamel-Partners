 ...
 */
export default {
  page: {title: "check in report", meta: [{ name: "check in report", content: "check in report" }],},
  mixins: [translation,customTable,successError,crudHelper],
  beforeRouteEnter(to, from, next) {
    next((vm) => {
      return permissionGuard(vm, "check in report", "all check in report");
    });
  },
  components: {
  ...
  data() {
    return {
      ...
      tableSetting: [
          {
              isFilter: false,isSet: true,trans:"check_in_report_serial_number", isV: 'prefix',
              type: 'relation',name: 'document_header',sort: false,col1: 'prefix',col2: 'prefix',
              setting: {"prefix":true},isSetting: true
          },
          {
              isFilter: false,isSet: true,trans:"check_in_report_customer", isV: 'customer_id'
          ...
          {
              isFilter: false,isSet: true,trans:"check_in_report_date_from",isV: 'date_from',
              type: 'date',sort: true,setting: {"date_from":true},isSetting: true
          },
          {
              isFilter: false,isSet: true,trans:"check_in_report_booking_days",isV: 'rent_days',
              type: 'string',sort: true,setting: {"rent_days":true},isSetting: true
          },
          {
              isFilter: false,isSet: true,trans:"check_in_report_date_to",isV: 'date_to',
              type: 'date',sort: true,setting: {"date_to":true},isSetting: true
          },
          {
              isFilter: false,isSet: true,trans:"check_in_report_check_in_time",isV: 'check_in_time',
              type: 'string',sort: true,setting: {"check_in_time":true},isSetting: true
          },
          {
              isFilter: false,isSet: true,trans:"check_in_report_room",isV: 'unit_id',
              type: 'relation', name:'unit',sort: false,col1: 'name',col2: 'name_e',
              setting: {"unit_id":true},isSetting: true
          },
          {
              isFilter: false,isSet: true,trans:"check_in_report_price_per_day",isV: 'price_per_uint',
              type: 'string',setting: {"price_per_uint":true},isSetting: true
          },
          {
              isFilter: false,isSet: true,trans:"check_in_report_total",isV: 'total',
              type: 'string',setting: {"total":true},isSetting: true
          },
          {
              isFilter: false,isSet: true,trans:"check_in_report_discount",isV: 'discount',
  ...
  methods: {
    settingFun(setting = null){
      ...
      filterDataApi()
      {
          this.getData(1,this.url+`?document_id=33&date_from=${this.create.start_date}&date_to=${this.create.end_date}&customer_id=${this.create.customer_id ? this.create.customer_id:''}&`,'');
      }
  }
};
</script>
