...
import Guest from "../../../components/create/booking/guest";
/**
...
export default {
    page: {
        title: "Booking Guest",
        meta: [{ name: "Booking Guest", content: "Booking Guest" }],
    },
    mixins: [translation,customTable,successError,crudHelper],
    beforeRouteEnter(to, from, next) {
        next((vm) => {
            return permissionGuard(vm, "Booking Guest", "all Booking Guest");
        });
    },
    components: {
        Layout, PageHeader, Guest,loader,
        searchPage,actionSetting, tableCustom
    },
    data() {
        return {
            url: '/general-customer?type=1',
            searchMain: '',
            tableSetting: [
                {
                    isFilter: true,isSet: true,trans:"guest_name_ar",isV: 'name',
                    type: 'string',sort: true,setting: {"name":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"guest_name_en",isV: 'name_e',
                    type: 'string',sort: true,setting: {"name_e":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"guest_employee",isV: 'employee_id',
                    type: 'relation', name:'employee',sort: false,col1: 'name',col2: 'name_e',
                    setting: {"employee_id":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"guest_phone",isV: 'phone',
                    type: 'string',sort: true,setting: {"phone":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"guest_email",isV: 'email',
                    type: 'string',sort: true,setting: {"email":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"guest_id_number",isV: 'id_number',
                    type: 'string',sort: true,setting: {"id_number":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"guest_address",isV: 'address',
                    type: 'string',sort: true,setting: {"address":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"guest_nationality",isV: 'nationality',
                    type: 'string',sort: true,setting: {"nationality":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"guest_passport_number",isV: 'passport_no',
                    type: 'string',sort: true,setting: {"passport_no":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"guest_passport_expiration_date",isV: 'passport_expiry_date',
                    type: 'string',sort: true,setting: {"passport_expiry_date":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"guest_visa_number",isV: 'visa_no',
                    type: 'string',sort: true,setting: {"visa_no":true},isSetting: true
                },
            ],
            sendSetting: {},
            searchField: [],
    ...
    methods: {
        filterSearch(fields){
            let indexEmp = fields.indexOf("employee_id"),
                filter = '';
            if (indexEmp > -1) {
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <actionSetting
                            ...
                            :permissionCreate="isPermission('create guest')"
                            :permissionUpdate="isPermission('update guest')"
                            :permissionDelete="isPermission('delete guest')" :isExcl="true"
                        ...
                        >
                            ...
                            <tableCustom
                                ...
                                :permissionUpdate="isPermission('update guest')"
                                :permissionDelete="isPermission('delete guest')"
