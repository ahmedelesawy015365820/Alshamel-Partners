...
import productRuturn from "./components/productRuturn";
...
export default {
  page: {
    title: "sales returns",
    meta: [{ name: "description", content: "Sale Returns" }],
  },
  mixins: [translation],
  components: {
      productRuturn,
  ...
  beforeRouteEnter(to, from, next) {
          next((vm) => {
    return permissionGuard(vm, "POS return", "all POS return");
  });
...
<template>
  <Layout>
    <PageHeader />
    <NavTab @selectedBranch="selectedBranch = $event" type="sales" />
    <div class="row">
      <div class="col-lg-7">
        <productRuturn :selectedBranch="selectedBranch" type="sales" />
      </div>
      <div
        class="col-lg-5"
        :style="
        ...
        "
      >
        <orderReturn type="sales" :companyKeys="companyKeys" :defaultsKeys="defaultsKeys" />
      </div>
    </div>
  </Layout>
</template>
