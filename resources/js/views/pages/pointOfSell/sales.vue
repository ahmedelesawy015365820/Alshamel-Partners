...
export default {
  ...
  beforeRouteEnter(to, from, next) {
          next((vm) => {
    return permissionGuard(vm, "POS sales", "all Bank Account");
  });
...
<template>
  <Layout>
    <PageHeader />
    <NavTab type="sales" @selectedBranch="selectedBranch = $event" />
    <div class="row">
      <div class="col-lg-7">
        <Products type="sales" :currency="currency" :selectedBranch="selectedBranch" />
      </div>
      <div
        class="col-lg-5"
        :style="
        ...
        "
      >
        <Order :isPermission="isPermission" type="sales" :currency="currency" :selectedBranch="selectedBranch" :companyKeys="companyKeys" :defaultsKeys="defaultsKeys" />
      </div>
    </div>
  </Layout>
</template>
