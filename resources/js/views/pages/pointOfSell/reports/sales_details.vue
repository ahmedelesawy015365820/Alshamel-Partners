...
export default {
  page: {
    ...
    meta: [{ name: "description", content: "Sales Details Report" }],
  },
  mixins: [translation],
  components: {
    Multiselect,
  ...
  beforeRouteEnter(to, from, next) {
    next((vm) => {
      return permissionGuard(
        vm,
        "POS sales details report",
        "all POS sales details report"
      );
    });
  },
  methods: {
    ...
    async getTotal() {
      ...
      await adminApi
        .get(
          `/point-of-sale/sales-details/grandTotal?start_date=${
            this.from_date ?? ""
          }
    ...
    getData(page = 1) {
      ...
      adminApi
        .get(
          `/point-of-sale/sales-details?page=${page}&per_page=${this.per_page}
    ...
    getDataCurrentPage(page = 1) {
      if (
        ...
        adminApi
          .get(
            `/point-of-sale/sales-details?page=${this.current_page}&per_page=${
              this.per_page
            }
          &start_date=${this.from_date ?? ""}
          &end_date=${this.to_date ?? ""}
    ...
    async getInvoices() {
      await adminApi
        .get(`/point-of-sale/sales-details/getInvoiceId`)
        .then((res) => {
    ...
    >
      <div class="row mb-2 px-2">
        ...
        <div class="col-md-2">
          ...
          <multiselect
            v-model="invoice_id"
            :options="invoices.map((type) => type.prefix)"
          >
          </multiselect>
        </div>
      </div>
                ...
                <div class="d-fex">
                  ...
                  <div class="d-inline-block">
                    ...
                    >
                      ...
                      <b-form-checkbox v-model="setting.items" class="mb-1">
                        {{ getCompanyKey("items") }}
                      </b-form-checkbox>
                      <b-form-checkbox
              ...
              >
                <thead>
                  <tr>
                    ...
                    <th v-if="setting.items">
                      <div class="d-flex justify-content-center">
                        <span>{{ getCompanyKey("items") }}</span>
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
