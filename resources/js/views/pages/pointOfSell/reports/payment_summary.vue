...
export default {
  page: {
    ...
    meta: [{ name: "description", content: "Payment Summary Report" }],
  },
  mixins: [translation],
  components: {
    Multiselect,
  ...
  methods: {
    ...
    async getTotal() {
      ...
      await adminApi
        .get(
          `/point-of-sale/payment-summary-report/grandTotal?end_date=${
            this.to_date ?? ""
          }
          &group=${this.group ?? ""}
    ...
    getData(page = 1) {
      ...
      adminApi
        .get(
          `/point-of-sale/payment-summary-report?page=${page}&per_page=${
            this.per_page
          }
        ...
        .then((res) => {
          ...
          items.push({
            ...
            name: "اجمالي",
            name_e: "Total",
            total_paid: this.getItemsSumOf(items, "total_paid"),
          });
          items.push({
            bold: true,
            name: "المجموع الاجمالي",
            name_e: "Grand total",
            total_paid: this.total.total,
          });
    ...
    getDataCurrentPage(page = 1) {
      if (
        ...
        adminApi
          .get(
            `/point-of-sale/payment-summary-report?page=${
              this.current_page
          ...
          <div class="card-body">
            ...
            <div class="row justify-content-between align-items-center mb-2">
              <h4 class="header-title">
                {{ $t("general.paymentsSummaryReport") }}
              </h4>
