...
export default {
  ...
  methods: {
    ...
    async getTotal() {
      ...
      await adminApi
        .get(
          `/point-of-sale/CustomerSummary-report/grandTotal?customer_group_id=${
            this.group ?? ""
          }
    ...
    getData(page = 1) {
      ...
      adminApi
        .get(
          `/point-of-sale/CustomerSummary-report?page=${page}&per_page=${
            this.per_page
          }
          &customer_group_id=${this.group ?? ""}
          &branch_id=${this.branch_id ?? ""}
          `
        )
        .then((res) => {
          ...
          items.push({
            ...
            name: "اجمالي",
            name_e: "Total",
            total_sales: this.getItemsSumOf(items, "total_sales"),
            total_returned: this.getItemsSumOf(items, "total_returned"),
            total_payment: this.getItemsSumOf(items, "total_payment"),
            total_due: this.getItemsSumOf(items, "total_due"),
          });
          items.push({
            bold: true,
            name: "المجموع الاجمالي",
            name_e: "Grand total",
            total_sales: this.total.total_sales,
            total_returned: this.total.total_returned,
            total_payment: this.total.total_payment,
            total_due: this.total.total_due,
          });
        ...
        <div class="col-md-12">
          ...
          <multiselect
            ...
            :custom-label="
              (opt) =>
                $i18n.locale == 'ar'
                  ? groups.find((x) => x.id == opt).title
                  : groups.find((x) => x.id == opt).title_e
            "
          >
          </multiselect>
        </div>
          ...
          <div class="card-body">
            ...
            <div class="row justify-content-between align-items-center mb-2">
              <h4 class="header-title">
                {{ $t("general.customerSummaryReport") }}
              </h4>
                ...
                <div class="d-fex">
                  ...
                  <div class="d-inline-block">
                    ...
                    >
                      ...
                      <b-form-checkbox
                        v-model="setting.total_sales"
                        class="mb-1"
                      >
                        {{ getCompanyKey("total_sales") }}
                      </b-form-checkbox>
                      <b-form-checkbox
                        v-model="setting.total_return"
                        class="mb-1"
                      >
                        {{ getCompanyKey("total_return") }}
                      </b-form-checkbox>
                      <b-form-checkbox
              ...
              >
                <thead>
                  <tr>
                    ...
                    <th v-if="setting.total_sales">
                      <div class="d-flex justify-content-center">
                        <span>{{ getCompanyKey("total_sales") }}</span>
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                    ...
                    <th v-if="setting.total_return">
                      <div class="d-flex justify-content-center">
                        <span>{{ getCompanyKey("total_return") }}</span>
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                ...
                <tbody v-if="items.length > 0">
                  ...
                  >
                    ...
                    <td v-if="setting.total_sales">
                      {{ data.total_sales }}
                    </td>
                    <td v-if="setting.total_return">
                      {{ data.total_returned }}
                    </td>
