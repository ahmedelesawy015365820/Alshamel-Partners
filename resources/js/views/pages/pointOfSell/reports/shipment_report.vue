...
export default {
  page: {
    ...
    meta: [{ name: "description", content: "Shipment Report" }],
  },
  mixins: [translation],
  components: {
    Multiselect,
              ...
              >
                <thead>
                  <tr>
                    ...
                    <th v-if="setting.shipping_area">
                      <div class="d-flex justify-content-center">
                        <span>{{ getCompanyKey("shipping_area") }}</span>
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                    ...
                    <th v-if="setting.address">
                      <div class="d-flex justify-content-center">
                        <span>{{ getCompanyKey("address") }}</span>
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                            @click="items.sort(sortString('start_date'))"
                    ...
                    <th v-if="setting.shipping_cost">
                      <div class="d-flex justify-content-center">
                        <span>{{ getCompanyKey("shipping_cost") }}</span>
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                            @click="items.sort(sortString('start_date'))"
                    ...
                    <th v-if="setting.status">
                      <div class="d-flex justify-content-center">
                        <span>{{ getCompanyKey("shipping_status") }}</span>
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
                            @click="items.sort(sortString('start_date'))"
