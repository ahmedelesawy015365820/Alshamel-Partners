...
export default {
  page: {
    title: "Tax Report",
    meta: [{ name: "description", content: "Tax Report" }],
  },
  mixins: [translation],
  components: {
    Multiselect,
  ...
  methods: {
    ...
    async getTotal() {
      ...
      await adminApi
        .get(
          `/point-of-sale/tax-report/grandTotal?branch_id=${
            this.branch_id ?? ""
          }
    ...
    getData(page = 1) {
      ...
      adminApi
        .get(
          `/point-of-sale/tax-report?page=${page}&per_page=${this.per_page}
    ...
    getDataCurrentPage(page = 1) {
      if (
        ...
        adminApi
          .get(
            `/point-of-sale/tax-report?page=${this.current_page}&per_page=${
              this.per_page
            }
          &branch_id=${this.branch_id ?? ""}
          &start_date=${this.from_date ?? ""}
                ...
                <div class="d-fex">
                  ...
                  <div class="d-inline-block">
                    ...
                    >
                      ...
                      <b-form-checkbox
                        v-model="setting.order_type"
                        class="mb-1"
                      >
                        {{ getCompanyKey("order_type") }}
                      </b-form-checkbox>
              ...
              >
                <thead>
                  <tr>
                    ...
                    <th v-if="setting.order_type">
                      <div class="d-flex justify-content-center">
                        <span>{{ getCompanyKey("order_type") }}</span>
                        <div class="arrow-sort">
                          <i
                            class="fas fa-arrow-up"
