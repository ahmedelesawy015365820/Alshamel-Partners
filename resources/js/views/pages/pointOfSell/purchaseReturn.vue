...
export default {
  ...
  beforeRouteEnter(to, from, next) {
          next((vm) => {
    return permissionGuard(vm, "POS purchase return", "all POS purchase return");
  });
...
<template>
  <Layout>
    ...
    <div class="row">
      <div class="col-lg-7">
        <productRuturn :selectedBranch="selectedBranch" type="purchase" />
      </div>
      <div
        class="col-lg-5"
        :style="
        ...
        "
      >
        <orderReturn type="purchase" :companyKeys="companyKeys" :defaultsKeys="defaultsKeys" />
      </div>
    </div>
  </Layout>
</template>
