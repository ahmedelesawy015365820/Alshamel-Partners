...
import SalesmanType from "../../../../components/create/general/salesManType";
/**
...
export default {
    ...
    components: {
        ...
        actionSetting, tableCustom, SalesmanType
    },
    beforeRouteEnter(to, from, next) {
        next((vm) => {
            return permissionGuard(vm, "Salesman Type", "all Sales Man Type");
        });
    ...
    data() {
        return {
            ...
            tableSetting: [
                {
                    isFilter: true,isSet: true,trans:"sale_man_type_name_ar",isV: 'name',
                    type: 'string',sort: true,setting: {"name":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"sale_man_type_name_en",isV: 'name_e',
                    type: 'string',sort: true,setting: {"name_e":true},isSetting: true
                },
                {
                    isFilter: false,isSet: true,trans:"is_employee",isV: 'is_employee',
                    type: 'boolean',setting: {"is_employee":true},isSetting: true
                }
            ],
            sendSetting: {},
            searchField: [],
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <actionSetting
                            ...
                            :permissionCreate="isPermission('create Sales Man Type')"
                            :permissionUpdate="isPermission('update Sales Man Type')"
                            :permissionDelete="isPermission('delete Sales Man Type')" :isExcl="true"
                        ...
                        >
                            ...
                            <tableCustom
                                ...
                                :permissionUpdate="isPermission('update Sales Man Type')"
                                :permissionDelete="isPermission('delete Sales Man Type')"
