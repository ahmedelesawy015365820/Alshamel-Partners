...
import Status from "../../../../components/create/general/status";
...
export default {
  ...
  beforeRouteEnter(to, from, next) {
    next((vm) => {
      return permissionGuard(vm, "Status", "all Status");
    });
  },
  data() {
    return {
        ...
        tableSetting: [
            {
                isFilter: true,isSet: true,trans:"statuses_name_ar",isV: 'name',
                type: 'string',sort: true,setting: {"name":true},isSetting: true
            },
            {
                isFilter: true,isSet: true,trans:"statuses_name_en",isV: 'name_e',
                type: 'string',sort: true,setting: {"name_e":true},isSetting: true
            },
            {
                isFilter: true,isSet: true,trans:"statuses_color",isV: 'color',
                type: 'string',sort: true,setting: {"color":true},isSetting: true
            },
            {
                isFilter: true,isSet: true,trans:"statuses_icon",isV: 'icon',
                type: 'string',sort: true,setting: {"icon":true},isSetting: true
            },
            {
                isFilter: true,isSet: true,trans:"statuses_module_type",isV: 'module_type',
                type: 'string',sort: true,setting: {"module_type":true},isSetting: true
            },
        ],
        sendSetting: {},
        searchField: [],
