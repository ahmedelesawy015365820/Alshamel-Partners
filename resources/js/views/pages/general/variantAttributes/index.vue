...
import Variant from "../../../../components/create/general/variant-attributes";
...
export default {
    page: {
        ...
        meta: [{ name: "description", content: "Variant Attributes" }],
    },
    mixins: [translation,customTable,successError,crudHelper],
    components: {
        Layout, PageHeader,loader, Variant,
        searchPage,actionSetting, tableCustom
    },
    beforeRouteEnter(to, from, next) {
    next((vm) => {
      return permissionGuard(vm, "Variant Attributes", "all Customer");
    });
  },
    data() {
        return {
            ...
            tableSetting: [
                {
                    isFilter: true,isSet: true,trans:"variant_attributes_name_ar",isV: 'name',
                    type: 'string',sort: true,setting: {"name":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"variant_attributes_name_en",isV: 'name_e',
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <actionSetting
                            ...
                            :permissionCreate="isPermission('create Category')"
                            :permissionUpdate="isPermission('update Category')"
                            :permissionDelete="isPermission('delete Category')" :isExcl="true"
                        ...
                        >
                            ...
                            <tableCustom
                                ...
                                :permissionUpdate="isPermission('update Category')"
                                :permissionDelete="isPermission('delete Category')"
