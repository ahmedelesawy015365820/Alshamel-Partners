...
import PaymentType from "../../../../components/create/general/payment-type";
...
export default {
  ...
  components: {
        Layout, PageHeader,loader, PaymentType,
        searchPage,actionSetting, tableCustom
    },
  beforeRouteEnter(to, from, next) {
    next((vm) => {
      return permissionGuard(vm, "Payment Type", "all Payment Type");
    });
  },
  data() {
    return {
        ...
        tableSetting: [
            {
                isFilter: true,isSet: true,trans:"payment_type_name_ar",isV: 'name',
                type: 'string',sort: true,setting: {"name":true},isSetting: true
            },
            {
                isFilter: true,isSet: true,trans:"payment_type_name_en",isV: 'name_e',
                type: 'string',sort: true,setting: {"name_e":true},isSetting: true
            },
            {
                isFilter: false,isSet: true,trans:"payment_type_default",isV: 'is_default',
        ...
        <div class="card">
          <div class="card-body">
              ...
              <actionSetting
                  ...
                  :permissionCreate="isPermission('create Payment Type')"
                  :permissionUpdate="isPermission('update Payment Type')"
                  :permissionDelete="isPermission('delete Payment Type')" :isExcl="true"
            ...
            >
              ...
              <!--       end loader       -->
                ...
                <tableCustom
                    ...
                    :permissionUpdate="isPermission('update Payment Type')"
                    :permissionDelete="isPermission('delete Payment Type')"
