...
import DocumrntStatus from "../../../../components/create/general/document-status";
...
export default {
  page: {
    ...
    meta: [{ name: "description", content: "document status" }],
  },
  mixins: [translation,customTable,successError,crudHelper],
  components: {
        Layout, PageHeader, loader, DocumrntStatus,
  ...
  data() {
    return {
        ...
        tableSetting: [
            {
                isFilter: true,isSet: true,trans:"document_status_name_ar",isV: 'name',
                type: 'string',sort: true,setting: {"name":true},isSetting: true
            },
            {
                isFilter: true,isSet: true,trans:"document_status_name_en",isV: 'name_e',
                type: 'string',sort: true,setting: {"name_e":true},isSetting: true
            },
            {
                isFilter: false,isSet: true,trans:"document_status_status",isV: 'is_active',
                type: 'boolean',setting: {"is_active":true},isSetting: true
            },
            {
                isFilter: false,isSet: true,trans:"document_status_default",isV: 'is_default',
  ...
  beforeRouteEnter(to, from, next) {
        next((vm) => {
      return permissionGuard(vm, "Document Status", "all document status");
    });
   },
  methods: {
      filterSearch(fields){
