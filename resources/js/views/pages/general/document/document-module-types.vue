...
import DocumentModuleTypes from "../../../../components/create/general/document-module-types";
...
export default {
  page: {
    ...
    meta: [{ name: "document linked categories", content: "document linked categories" }],
  },
  mixins: [translation,customTable,successError,crudHelper],
  components: {
        Layout, PageHeader, loader, DocumentModuleTypes,
  ...
  data() {
    return {
        ...
        tableSetting: [
            {
                isFilter: true,isSet: true,trans:"document_linked_categories_name_ar",isV: 'name',
                type: 'string',sort: true,setting: {"name":true},isSetting: true
            },
            {
                isFilter: true,isSet: true,trans:"document_linked_categories_name_en",isV: 'name_e',
                type: 'string',sort: true,setting: {"name_e":true},isSetting: true
            },
            {
                isFilter: true,isSet: true,trans:"document_linked_categories_title_ar",isV: 'title',
                type: 'string',sort: true,setting: {"title":true},isSetting: true
            },
            {
                isFilter: true,isSet: true,trans:"document_linked_categories_title_en",isV: 'title_e',
                type: 'string',sort: true,setting: {"title_e":true},isSetting: true
            },
            {
                isFilter: true,isSet: true,trans:"document_linked_categories_db_table",isV: 'db_table',
                type: 'string',sort: true,setting: {"db_table":true},isSetting: true
            },
  ...
  beforeRouteEnter(to, from, next) {
        next((vm) => {
      return permissionGuard(vm, "document linked categories", "all document linked categories");
    });
   },
  methods: {
      filterSearch(fields){
        ...
        <div class="card">
          <div class="card-body">
              ...
              <actionSetting
                  ...
                  :permissionCreate="isPermission('create Document Status')"
                  :permissionUpdate="isPermission('update Document Status')"
                  :permissionDelete="isPermission('delete Document Status')" :isExcl="true"
            ...
            >
              ...
              <!--       end loader       -->
                ...
                <tableCustom
                    ...
                    :permissionUpdate="isPermission('update Document Status')"
                    :permissionDelete="isPermission('delete Document Status')"
