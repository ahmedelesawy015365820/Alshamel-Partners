...
import Supplier from "../../../../components/create/general/supplier";
...
export default {
    ...
    next((vm) => {
      return permissionGuard(vm, "Supplier", "all Supplier");
    });
  },
    components: {
        Layout, PageHeader, Supplier,loader,
    ...
    mounted() {
        ...
        this.settingFun();
        this.getCustomTableFields('general_suppliers');
    ...
    methods: {
        filterSearch(fields){
            let indexC = fields.indexOf("country_id"),
                ...
                indexCoustomer = fields.indexOf("customer_id"),
                filter = '';
            if (indexCoustomer > -1) {
                fields[indexCoustomer] = this.$i18n.locale == "ar" ? "customer.name" : "customer.name_e";
            }
            if (indexC > -1) {
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <actionSetting
                            ...
                            :permissionCreate="isPermission('create Supplier')"
                            :permissionUpdate="isPermission('update Supplier')"
                            :permissionDelete="isPermission('delete Supplier')" :isExcl="true"
                        ...
                        >
                            ...
                            <tableCustom
                                ...
                                :permissionUpdate="isPermission('update Supplier')"
                                :permissionDelete="isPermission('delete Supplier')"
