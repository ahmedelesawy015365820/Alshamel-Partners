...
import LegalProcedure from "../../../../components/create/general/legalProcedure";
...
export default {
  page: {
    ...
    meta: [{ name: "description", content: "Legal Procedure" }],
  },
  ...
  beforeRouteEnter(to, from, next) {
    next((vm) => {
      return permissionGuard(vm, "Legal Procedure", "all LegalProcedure");
    });
  },
  data() {
    return {
        ...
        <div class="card">
          <div class="card-body">
            ...
            <actionSetting
              ...
              :isEdit="true"
              :isDelete="true"
              :permissionCreate="isPermission('create LegalProcedure')"
              :permissionUpdate="isPermission('update LegalProcedure')"
              :permissionDelete="isPermission('delete LegalProcedure')"
              :isExcl="true"
              :isPrint="true"
              :checkAll="checkAll"
              :sideAction="true"
