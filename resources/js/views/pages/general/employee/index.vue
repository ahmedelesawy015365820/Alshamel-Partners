...
export default {
    ...
    components: {
        Layout, PageHeader, loader, Employee,
        searchPage,actionSetting, tableCustom
    },
    beforeRouteEnter(to, from, next) {
        next((vm) => {
            return permissionGuard(vm, "Employee", "all Employee");
        });
    },
    data() {
        return {
            ...
            tableSetting: [
                {
                    isFilter: true,isSet: true,trans:"employee_name_ar",isV: 'name',
                    type: 'string',sort: true,setting: {"name":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"employee_name_en",isV: 'name_e',
                    type: 'string',sort: true,setting: {"name_e":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"employee_email",isV: 'email',
                    type: 'string',sort: true,setting: {"email":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"employee_mobile",isV: 'mobile',
                    type: 'string',sort: true,setting: {"mobile":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"employee_branch", isV: 'branch_id'
                    ,type: 'relation', name: 'branch',sort: false,col1: 'name',col2: 'name_e',
                    setting: {"branched_id":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"employee_department",isV: 'department_id',
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <actionSetting
                            ...
                            :permissionCreate="isPermission('create Employee')"
                            :permissionUpdate="isPermission('update Employee')"
                            :permissionDelete="isPermission('delete Employee')" :isExcl="true"
                        ...
                        >
                            ...
                            <tableCustom
                                ...
                                :permissionUpdate="isPermission('update Employee')"
                                :permissionDelete="isPermission('delete Employee')"
