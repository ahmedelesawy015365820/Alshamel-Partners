...
import Color from "../../../../components/create/general/color";
...
export default {
  ...
  components: {
        Layout, PageHeader,loader, Color,
        searchPage,actionSetting, tableCustom
  },
  beforeRouteEnter(to, from, next) {
    next((vm) => {
      return permissionGuard(vm, "Color", "all Color");
    });
  },
  data() {
        return {
            ...
            tableSetting: [
                {
                    isFilter: true,isSet: true,trans:"color_name_ar",isV: 'name',
                    type: 'string',sort: true,setting: {"name":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"color_name_en",isV: 'name_e',
                    type: 'string',sort: true,setting: {"name_e":true},isSetting: true
                },
                {
                    isFilter: false,isSet: true,trans:"color_status",isV: 'is_active',
        ...
        <div class="card">
          <div class="card-body">
              ...
              <actionSetting
                  ...
                  :permissionCreate="isPermission('create Color')"
                  :permissionUpdate="isPermission('update Color')"
                  :permissionDelete="isPermission('delete Color')" :isExcl="true"
            ...
            >
              ...
              <!--       end loader       -->
                ...
                <tableCustom
                    ...
                    :permissionUpdate="isPermission('update Color')"
                    :permissionDelete="isPermission('delete Color')"
