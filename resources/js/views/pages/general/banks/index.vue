...
import Bank from "../../../../components/create/general/bank";
...
export default {
  ...
  components: {
    ...
    actionSetting, tableCustom, Bank
  },
  beforeRouteEnter(to, from, next) {
        next((vm) => {
      return permissionGuard(vm, "Bank", "all Bank");
    });
  },
  data() {
    return {
        ...
        tableSetting: [
            ...
            {
                isFilter: true,isSet: true,trans:"bank_name_ar",isV: 'name',
                type: 'string',sort: true,setting: {"name":true},isSetting: true
            },
            {
                isFilter: true,isSet: true,trans:"bank_name_en",isV: 'name_e',
                type: 'string',sort: true,setting: {"name_e":true},isSetting: true
            },
            {
                isFilter: true,isSet: true,trans:"bank_swiftcode",isV: 'swift_code',
                type: 'string',sort: true,setting: {"swift_code":true},isSetting: true
            },
        ],
        sendSetting: {},
        searchField: [],
          ...
          <div class="card-body">
            ...
            <!-- start setting -->
              <actionSetting
                  ...
                  :permissionCreate="isPermission('create Bank')"
                  :permissionUpdate="isPermission('update Bank')"
                  :permissionDelete="isPermission('delete Bank')" :isExcl="true"
            ...
            >
              ...
              <!--       end loader       -->
               ...
               <tableCustom
                    ...
                    :permissionUpdate="isPermission('update Bank')"
                    :permissionDelete="isPermission('delete Bank')"
