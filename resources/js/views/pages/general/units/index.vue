...
export default {
  ...
  components: {
        Layout, PageHeader,loader, Unit,
        searchPage,actionSetting, tableCustom
    },
  beforeRouteEnter(to, from, next) {
        next((vm) => {
      return permissionGuard(vm, "Unit", "all Unit");
    });
  ...
  data() {
    return {
        ...
        tableSetting: [
            {
                isFilter: true,isSet: true,trans:"unit_name_ar",isV: 'name',
                type: 'string',sort: true,setting: {"name":true},isSetting: true
            },
            {
                isFilter: true,isSet: true,trans:"unit_name_en",isV: 'name_e',
                type: 'string',sort: true,setting: {"name_e":true},isSetting: true
            },
            {
                isFilter: false,isSet: true,trans:"unit_status",isV: 'is_active',
        ...
        <div class="card">
          <div class="card-body">
              ...
              <actionSetting
                  ...
                  :permissionCreate="isPermission('create Unit')"
                  :permissionUpdate="isPermission('update Unit')"
                  :permissionDelete="isPermission('delete Unit')" :isExcl="true"
            ...
            <div class="table-responsive mb-3 custom-table-theme position-relative" ref="exportable_table"
              ...
              <!--       end loader       -->
                ...
                <tableCustom
                    ...
                    :permissionUpdate="isPermission('update Unit')"
                    :permissionDelete="isPermission('delete Unit')"
