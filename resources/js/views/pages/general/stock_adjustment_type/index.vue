...
export default {
  page: {
    ...
    meta: [{ name: "description", content: "Stock adjustment type" }],
  },
  mixins: [translation, customTable, successError, crudHelper],
  beforeRouteEnter(to, from, next) {
    next((vm) => {
      return permissionGuard(vm, "Branch", "all Status");
    });
  },
  components: {
    Layout,
  ...
  data() {
    return {
      url: "/point-of-sale/adjust-stock-type",
      searchMain: "",
      tableSetting: [
        {
          isFilter: true,
          isSet: true,
          trans: "stock_adjustment_type_title_ar",
          isV: "title",
          type: "string",
          sort: true,
          setting: { title: true },
        ...
        },
        {
          isFilter: true,
          isSet: true,
          trans: "stock_adjustment_type_title_en",
          isV: "title_e",
          type: "string",
          sort: true,
          setting: { title_e: true },
          isSetting: true,
        },
      ],
      sendSetting: {},
  ...
  mounted() {
    this.searchField = this.tableSetting
      ...
      .map((el) => el.isV);
    this.settingFun();
    this.getCustomTableFields("pos_adjust_stock_types");
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-body">
            <!-- start search -->
            <searchPage
              page="general.stockAdjustmentTypeTable"
              :isVisible="isVisible"
            ...
            <actionSetting
              ...
              :isEdit="true"
              :isDelete="true"
              :permissionCreate="isPermission('create StockAdjustmentType')"
              :permissionUpdate="isPermission('update StockAdjustmentType')"
              :permissionDelete="isPermission('delete StockAdjustmentType')"
              :isExcl="true"
              :isPrint="true"
              :checkAll="checkAll"
              :sideAction="true"
