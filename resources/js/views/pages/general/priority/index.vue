...
import Priority from "../../../../components/create/general/Priority";
...
export default {
  page: {
    title: "Priority",
    meta: [{ name: "description", content: "priority" }],
  },
  mixins: [translation,customTable,successError,crudHelper],
  components: {
        Layout, PageHeader,loader, Priority,
        searchPage,actionSetting, tableCustom
    },
  beforeRouteEnter(to, from, next) {
    next((vm) => {
      return permissionGuard(vm, "Priority", "all Priority");
    });
  },
  data() {
    return {
        ...
        tableSetting: [
            {
                isFilter: true,isSet: true,trans:"priority_name_ar",isV: 'name',
                type: 'string',sort: true,setting: {"name":true},isSetting: true
            },
            {
                isFilter: true,isSet: true,trans:"priority_name_en",isV: 'name_e',
            ...
            {
                isFilter: false,isSet: true,trans:"priority_is_valid",isV: 'is_valid',
                type: 'boolean',setting: {"is_valid":true},isSetting: true
            },
            {
                isFilter: false,isSet: true,trans:"priority_is_default",isV: 'is_default',
        ...
        <div class="card">
          <div class="card-body">
              ...
              <actionSetting
                  ...
                  :permissionCreate="isPermission('create Priority')"
                  :permissionUpdate="isPermission('update Priority')"
                  :permissionDelete="isPermission('delete Priority')" :isExcl="true"
            ...
            >
              ...
              <!--       end loader       -->
                ...
                <tableCustom
                    ...
                    :permissionUpdate="isPermission('update Priority')"
                    :permissionDelete="isPermission('delete Priority')"
