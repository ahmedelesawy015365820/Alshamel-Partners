...
import Street from "../../../../components/create/general/street.vue";
 ...
 */
export default {
  page: {title: "Street", meta: [{ name: "description", content: "Street" }],},
  mixins: [translation,customTable,successError,crudHelper],
  beforeRouteEnter(to, from, next) {
    next((vm) => {
      return permissionGuard(vm, "Street", "all Street");
    });
  },
  components: {
      Layout, PageHeader, loader, Street,
  ...
  data() {
    return {
      ...
      tableSetting: [
          {
              isFilter: true,isSet: true,trans:"street_name_ar",isV: 'name',
              type: 'string',sort: true,setting: {"name":true},isSetting: true
          },
          {
              isFilter: true,isSet: true,trans:"street_name_en",isV: 'name_e',
              type: 'string',sort: true,setting: {"name_e":true},isSetting: true
          },
          {
              isFilter: true,isSet: true,trans:"street_avenue", isV: 'avenue_id',
              type: 'relation',name: 'avenue',sort: false,col1: 'name',col2: 'name_e',
              setting: {"avenue_id":true},isSetting: true
          },
          {
              isFilter: false,isSet: true,trans:"street_status",isV: 'is_active',
  ...
  methods: {
    filterSearch(fields){
        let indexC = fields.indexOf("avenue_id"),
            filter = '';
        if (indexC > -1) {
        ...
        <div class="card">
          <div class="card-body">
            ...
            <actionSetting
                ...
                :permissionCreate="isPermission('create Street')"
                :permissionUpdate="isPermission('update Street')"
                :permissionDelete="isPermission('delete Street')" :isExcl="true"
            ...
            >
              ...
              <tableCustom
                    ...
                    :permissionUpdate="isPermission('update Street')"
                    :permissionDelete="isPermission('delete Street')"
