...
import Tax from "../../../../components/create/general/taxes";
...
export default {
  ...
  data() {
    return {
        ...
        tableSetting: [
            {
                isFilter: true,isSet: true,trans:"taxes_name_ar",isV: 'name',
                type: 'string',sort: true,setting: {"name":true},isSetting: true
            },
            {
                isFilter: true,isSet: true,trans:"taxes_name_en",isV: 'name_e',
                type: 'string',sort: true,setting: {"name_e":true},isSetting: true
            },
            {
                isFilter: false,isSet: true,trans:"taxes_percentage",isV: 'percentage',
                type: 'string',sort: true,setting: {"percentage":true},isSetting: true
            },
            {
                isFilter: false,isSet: true,trans:"taxes_default",isV: 'is_default',
  ...
  beforeRouteEnter(to, from, next) {
    next((vm) => {
      return permissionGuard(vm, "Taxes", "all Customer");
    });
  },
  methods: {
      filterSearch(fields){
        ...
        <div class="card">
          <div class="card-body">
              ...
              <actionSetting
                  ...
                  :permissionCreate="isPermission('create Tax')"
                  :permissionUpdate="isPermission('update Tax')"
                  :permissionDelete="isPermission('delete Tax')" :isExcl="true"
            ...
            >
              ...
              <!--       end loader       -->
                ...
                <tableCustom
                    ...
                    :permissionUpdate="isPermission('update Tax')"
                    :permissionDelete="isPermission('delete Tax')"
