...
import SalesmanPlan from "../../../../components/create/general/salesmanPlan";
...
export default {
  page: {
    ...
    meta: [{ name: "description", content: "Sales man plan" }],
  },
  mixins: [translation,customTable,successError,crudHelper],
  components: {
        Layout, PageHeader,loader, SalesmanPlan,
        searchPage,actionSetting, tableCustom
  },
  beforeRouteEnter(to, from, next) {
        next((vm) => {
      return permissionGuard(vm, "Plan", "all Plan");
    });
  ...
  data() {
    return {
        ...
        tableSetting: [
            {
                isFilter: true,isSet: true,trans:"salesmanplan_name_ar",isV: 'name',
                type: 'string',sort: true,setting: {"name":true},isSetting: true
            },
            {
                isFilter: true,isSet: true,trans:"salesmanplan_name_en",isV: 'name_e',
                type: 'string',sort: true,setting: {"name_e":true},isSetting: true
            },
            {
                isFilter: false,isSet: true,trans:"source", isV: 'salesmen_plans_source_id',
                type: 'relation',name: 'salesmen_plans_source',sort: false,col1: 'name',col2: 'name_e',
                setting: {"salesmen_plans_source_id":true},isSetting: true
            },
            {
                isFilter: false,isSet: true,trans:"period", isV: 'restart_period_id',
  ...
  methods: {
      filterSearch(fields){
          let indexC = fields.indexOf("salesmen_plans_source_id"),
        ...
        <div class="card">
          <div class="card-body">
              ...
              <actionSetting
                  ...
                  :permissionCreate="isPermission('create Plan')"
                  :permissionUpdate="isPermission('update Plan')"
                  :permissionDelete="isPermission('delete Plan')" :isExcl="true"
            ...
            >
              ...
              <!--       end loader       -->
                <tableCustom
                    ...
                    :permissionUpdate="isPermission('update Plan')"
                    :permissionDelete="isPermission('delete Plan')"
