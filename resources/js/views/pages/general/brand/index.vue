...
export default {
    ...
    components: {
        ...
        actionSetting, tableCustom, Brand
    },
    beforeRouteEnter(to, from, next) {
         next((vm) => {
      return permissionGuard(vm, "Brand", "all Brand");
    });
    },
    data() {
        return {
            ...
            tableSetting: [
                {
                    isFilter: true,isSet: true,trans:"brand_name_ar",isV: 'name',
                    type: 'string',sort: true,setting: {"name":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"brand_name_en",isV: 'name_e',
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <actionSetting
                            ...
                            :permissionCreate="isPermission('create Brand')"
                            :permissionUpdate="isPermission('update Brand')"
                            :permissionDelete="isPermission('delete Brand')" :isExcl="true"
                        ...
                        <div class="table-responsive mb-3 custom-table-theme position-relative" ref="exportable_table"
                            ...
                            <tableCustom
                                ...
                                :permissionUpdate="isPermission('update Brand')"
                                :permissionDelete="isPermission('delete Brand')"
