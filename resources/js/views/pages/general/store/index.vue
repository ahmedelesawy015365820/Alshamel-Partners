...
import Store from "../../../../components/create/general/store.vue";
 ...
 */
export default {
  page: { title: "Store", meta: [{ name: "description", content: "Store" }] },
        ...
        <div class="card">
          <div class="card-body">
            ...
            <actionSetting
              ...
              :isEdit="true"
              :isDelete="true"
              :permissionCreate="isPermission('create Store')"
              :permissionUpdate="isPermission('update Store')"
              :permissionDelete="isPermission('delete Store')"
              :isExcl="true"
              :isPrint="true"
              :checkAll="checkAll"
              :sideAction="true"
