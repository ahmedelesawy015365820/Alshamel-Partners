...
import Salesman from "../../../../components/create/general/saleman";
...
export default {
  ...
  components: {
        ...
        actionSetting, tableCustom, Salesman
    },
  beforeRouteEnter(to, from, next) {
        next((vm) => {
            return permissionGuard(vm, "sales men", "all Sales Man");
        });
  ...
  data() {
    return {
        ...
        tableSetting: [
            {
                isFilter: true,isSet: true,trans:"sale_man_name_ar",isV: 'name',
                type: 'string',sort: true,setting: {"name":true},isSetting: true
            },
            {
                isFilter: true,isSet: true,trans:"sale_man_name_en",isV: 'name_e',
                type: 'string',sort: true,setting: {"name_e":true},isSetting: true
            },
            {
                isFilter: true,isSet: true,trans:"sale_man_type", isV: 'salesman_type_id'
                ,type: 'relation', name: 'salesmanType',sort: false,col1: 'name',col2: 'name_e',
                setting: {"salesman_type_id":true},isSetting: true
            },
        ],
        sendSetting: {},
        searchField: [],
  ...
  methods: {
      filterSearch(fields){
          let indexC = fields.indexOf("salesman_type_id"),
              filter = '';
          if (indexC > -1) {
        ...
        <div class="card">
          <div class="card-body">
              ...
              <actionSetting
                  ...
                  :permissionCreate="isPermission('create Sales Man')"
                  :permissionUpdate="isPermission('update Sales Man')"
                  :permissionDelete="isPermission('delete Sales Man')" :isExcl="true"
            ...
            >
              ...
              <!--       end loader       -->
                ...
                <tableCustom
                    ...
                    :permissionUpdate="isPermission('update Sales Man')"
                    :permissionDelete="isPermission('delete Sales Man')"
