...
import PaymentMethod from "../../../../components/create/general/payment-method";
...
export default {
  page: {
    ...
    meta: [{ name: "Payment Method", content: "Payment Method" }],
  },
  mixins: [translation,customTable,successError,crudHelper],
  components: {
        Layout, PageHeader,loader, PaymentMethod,
        searchPage,actionSetting, tableCustom
    },
  beforeRouteEnter(to, from, next) {
    next((vm) => {
      return permissionGuard(vm, "Payment Method", "all Payment Method");
    });
  },
  data() {
        return {
            ...
            tableSetting: [
                {
                    isFilter: true,isSet: true,trans:"payment_method_name_ar",isV: 'name',
                    type: 'string',sort: true,setting: {"name":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"payment_method_name_en",isV: 'name_e',
                    type: 'string',sort: true,setting: {"name_e":true},isSetting: true
                },
                {
                    isFilter: false,isSet: true,trans:"payment_method_default",isV: 'is_default',
        ...
        <div class="card">
          <div class="card-body">
              ...
              <actionSetting
                  ...
                  :permissionCreate="isPermission('create Payment Method')"
                  :permissionUpdate="isPermission('update Payment Method')"
                  :permissionDelete="isPermission('delete Payment Method')" :isExcl="true"
            ...
            >
              ...
              <!--       end loader       -->
                ...
                <tableCustom
                    ...
                    :permissionUpdate="isPermission('update Payment Method')"
                    :permissionDelete="isPermission('delete Payment Method')"
