...
import CustomerGroup from "../../../../components/create/general/customer_group";
...
export default {
    page: {
        ...
        meta: [{name: "description", content: "Customer Groups"}],
    },
    mixins: [translation,customTable,successError,crudHelper],
    components: {
        Layout, PageHeader, loader, CustomerGroup,
    ...
    data() {
        return {
            ...
            tableSetting: [
                {
                    isFilter: true,isSet: true,trans:"customer_groups_title_ar",isV: 'title',
                    type: 'string',sort: true,setting: {"title":true},isSetting: true
                },
                {
                    isFilter: true,isSet: true,trans:"customer_groups_title_en",isV: 'title_e',
                    type: 'string',sort: true,setting: {"title_e":true},isSetting: true
                },
                {
                    isFilter: false,isSet: true,trans:"customer_groups_discount",isV: 'discount',
                    type: 'string',sort: true,setting: {"discount":true},isSetting: true
                },
                {
                    isFilter: false,isSet: true,trans:"customer_groups_default",isV: 'is_default',
    ...
    beforeRouteEnter(to, from, next) {
        next((vm) => {
          return permissionGuard(vm, "Customer Group", "all customer groups");
        });
    },
    methods: {
        filterSearch(fields){
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <actionSetting
                            ...
                            :permissionCreate="isPermission('create Currency')"
                            :permissionUpdate="isPermission('update Currency')"
                            :permissionDelete="isPermission('delete Currency')" :isExcl="true"
                        ...
                        <div class="table-responsive mb-3 custom-table-theme position-relative">
                            ...
                            <tableCustom
                                ...
                                :permissionUpdate="isPermission('update Currency')"
                                :permissionDelete="isPermission('delete Currency')"
